          ...
          type = lib.types.submodule {
            options = {
              ...
              slotTypeOverrides = lib.mkOption {
                ...
                description = "Slot assignments to use if manualSlotSelection is enabled. Any assignents after the first 20 will be ignored. !Adding, moving, or removing slots of the amulet, ring, or belt types will reduce compatibility with mods made for original Baubles versions! [default: [amulet], [ring], [ring], [belt]]";
              };
            };
          };
        };
