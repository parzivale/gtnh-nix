      ...
      meteor = lib.mkOption {
        ...
        type = lib.types.submodule {
          ...
          defaultMeteorBlock = lib.mkOption {
            type = lib.types.str;
            default = "";
            description = "The block to use for filler in meteors if none is provided in the meteor's config file and that
...
\"modId:itemName:meta\"
Defaults to minecraft:stone:0 if no block is provided or the provided block cannot be found. [default: ]";
          };
          defaultMeteorCost = lib.mkOption {
            type = lib.types.int;
            default = 1000000;
            description = "The default LP cost to use for meteors if the \"cost\" property is not present in its config file.
[range: 0 ~ 2147483647, default: 1000000]";
      ...
      "rune overrides" = lib.mkOption {
        ...
        type = lib.types.submodule {
          ...
          specialBlocks = lib.mkOption {
            type = lib.types.listOf lib.types.str;
            default = [ "dreamcraft:tile.BloodyThaumium:0" "minecraft:glowstone:0" "dreamcraft:tile.BloodyVoid:0" "AWWayofTime:largeBloodStoneBrick:0" "etfuturum:beacon:0" "dreamcraft:tile.BloodyIchorium:0" "AWWayofTime:blockCrystal:0" ];
            description = "Set the special blocks for the altar with the format mod:block(:meta) in the following order:
Tier 3 pillar
Tier 3 cap
Tier 4 pillar
Tier 4 cap
      ...
      "teleposer blacklist" = lib.mkOption {
        ...
        type = lib.types.submodule {
          ...
          Blacklist = lib.mkOption {
            ...
            description = "Stops specified blocks from being teleposed. Put entries on new lines. Valid syntax is:
