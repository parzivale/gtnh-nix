          ...
          type = lib.types.submodule {
            options = {
              ...
              specialBlocks = lib.mkOption {
                ...
                description = "Set the special blocks for the altar with the format mod:block(:meta) in the following order: Tier 3 pillar Tier 3 cap Tier 4 pillar Tier 4 cap Tier 5 beacon Tier 6 pillar Tier 6 cap Set any of these to minecraft:air to allow for that component to be any block EXCEPT air (e.g., let any block be used for a pillar).";
              };
