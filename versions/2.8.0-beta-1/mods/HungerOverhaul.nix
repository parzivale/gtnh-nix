      ...
      food = lib.mkOption {
        ...
        type = lib.types.submodule {
          ...
          foodHungerToSaturationDivider = lib.mkOption {
            type = lib.types.str;
            default = "20.0";
            description = "Food values not manually set (see 'useHOFoodValues') will have their saturation modifier set to <modified hunger> divided by this ('modifyFoodValues' must be true)
Set to 0 to disable [vanilla: 0.0] [range: -3.4028235E38 ~ 3.4028235E38, default: 20.0]";
          };
          foodSaturationDivider = lib.mkOption {
            type = lib.types.str;
            default = "1.0";
            description = "Food values not manually set (see 'useHOFoodValues') will have their saturation modifier divided by this ('modifyFoodValues' must be true)
      ...
      natura = lib.mkOption {
        ...
        type = lib.types.submodule {
          ...
          removeNaturaFlourCraftingRecipes = lib.mkOption {
            type = lib.types.bool;
            default = true;
            description = "Removes the default barley/wheat -> flour recipes.
