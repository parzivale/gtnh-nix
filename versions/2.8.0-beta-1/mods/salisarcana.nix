{lib, ...}: {
  ...
  commands_cfg = lib.mkOption {
    ...
    type = lib.types.submodule {
      ...
      export_research = lib.mkOption {
        default = {};
        type = lib.types.submodule {
          options = {
          aliases = lib.mkOption {
            type = lib.types.listOf lib.types.str;
            default = [ "export-research" ];
            description = "Secondary names that refer to this command. [default: [export-research]]";
          };
          commandEnabled = lib.mkOption {
            type = lib.types.bool;
            default = true;
      ...
      general = lib.mkOption {
        ...
        type = lib.types.submodule {
          ...
          "Save Thaumonomicon Page" = lib.mkOption {
            type = lib.types.bool;
            default = true;
            description = "When closing the Thaumonomicon, it will remember the page you are on when it is reopened. Requires Right-Click Navigation to be enabled. [default: true]";
          };
          ...
          thaumometerScanContainersResearch = lib.mkOption {
            type = lib.types.str;
            default = "salisarcana:CHESTSCAN";
          };
          thaumometerScanResearchEnabled = lib.mkOption {
            type = lib.types.bool;
            default = true;
          };
      ...
      harvestlevels = lib.mkOption {
        ...
        type = lib.types.submodule {
          ...
          crusherHarvestLevel = lib.mkOption {
            type = lib.types.int;
            default = 5;
            description = "Override the harvest level of the primal crusher. [range: 0 ~ 2147483647, default: 5]";
          };
      ...
      infusion = lib.mkOption {
        ...
        type = lib.types.submodule {
          ...
          stabilizerAdditions = lib.mkOption {
            type = lib.types.listOf lib.types.str;
            default = [ ];
            description = "Requires useStabilizerRewrite=true.
      ...
      wand_component_swapping = lib.mkOption {
        ...
        type = lib.types.submodule {
          ...
          enforceWandCoreTypes = lib.mkOption {
            type = lib.types.bool;
            default = true;
            description = "If enabled, prevents swapping a wand core with a staff core or a staff core with a wand core.
Disable to allow upgrading a wand to a staff and vice versa. [default: true]";
          ...
          replaceWandCapsResearchName = lib.mkOption {
            type = lib.types.str;
            default = "REPLACEWANDCAPS";
          };
          ...
          replaceWandCoreResearchName = lib.mkOption {
            type = lib.types.str;
            default = "REPLACEWANDCORE";
          };
      ...
      modules = lib.mkOption {
        ...
        type = lib.types.submodule {
          ...
          "Enable biome_colors module" = lib.mkOption {
            type = lib.types.bool;
            default = false;
            description = "Notice: This is broken for some users, and slated for removal in a future update.
