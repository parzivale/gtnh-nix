      ...
      general = lib.mkOption {
        ...
        type = lib.types.submodule {
          ...
          "Scroll item scaling" = lib.mkOption {
            ...
            description = "This determines how many items are moved when you scroll. On some setups (notably macOS), scrolling the wheel with different speeds results in different distances scrolled per wheel \"bump\". To make those setups play nicely with Mouse Tweaks, set this option to \"Always exactly one item\".
...
[default: PROPORTIONAL]";
          ...
          "Wheel tweak scroll direction" = lib.mkOption {
            type = lib.types.str;
            default = "NORMAL";
            description = "Inventory position aware means scroll up to push items from the bottom inventory and pull into the top inventory, and vice versa.
...
[default: NORMAL]";
          ...
          "Wheel tweak search order" = lib.mkOption {
            ...
            description = "How to pick the source slot when pulling items via scrolling.
