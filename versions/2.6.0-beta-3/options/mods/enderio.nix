          ...
          type = lib.types.submodule {
            options = {
              advancedFluidConduitExtractRate = lib.mkOption {
                type = lib.types.int;
                default = 100;
                description = "Number of millibuckets per tick extracted by pressurized fluid conduits auto extracting";
              };
              advancedFluidConduitMaxIoRate = lib.mkOption {
                type = lib.types.int;
                default = 400;
                description = "Number of millibuckets per tick that can pass through a single connection to an pressurized fluid conduit.";
              };
              enderFluidConduitExtractRate = lib.mkOption {
                type = lib.types.int;
                default = 200;
                description = "Number of millibuckets per tick extracted by ender fluid conduits auto extracting";
              };
              enderFluidConduitMaxIoRate = lib.mkOption {
                type = lib.types.int;
                default = 800;
                description = "Number of millibuckets per tick that can pass through a single connection to an ender fluid conduit.";
              };
              ...
              fluidConduitExtractRate = lib.mkOption {
                type = lib.types.int;
                default = 50;
                description = "Number of millibuckets per tick extracted by a fluid conduits auto extracting";
              };
              fluidConduitMaxIoRate = lib.mkOption {
                type = lib.types.int;
                default = 200;
                description = "Number of millibuckets per tick that can pass through a single connection to a fluid conduit.";
              };
          ...
          type = lib.types.submodule {
            options = {
              magnetAllowDeactivatedInBaublesSlot = lib.mkOption {
                type = lib.types.bool;
                default = false;
                description = "If true the magnet can be put into the 'amulet' Baubles slot even if switched off (requires Baubles to be installed and magnetAllowInBaublesSlot to be on)";
              };
              ...
              magnetBaublesType = lib.mkOption {
                type = lib.types.str;
                default = "AMULET";
                description = "The BaublesType the magnet should be, 'AMULET', 'RING' or 'BELT' (requires Baubles to be installed and magnetAllowInBaublesSlot to be on)";
              };
          ...
          type = lib.types.submodule {
            options = {
              ...
              transceiverEnergyLoss = lib.mkOption {
                type = lib.types.float;
                default = 0.1;
                description = "Amount of energy lost when transfered by Dimensional Transceiver; 0 is no loss, 1 is 100% loss";
              };
          ...
          type = lib.types.submodule {
            options = {
              ...
              soulBinderLevelThreePowerPerTickRF = lib.mkOption {
                type = lib.types.int;
                default = 2000;
                description = "The number of RF/t consumed by a soul binder with an octadic capacitor upgrade.";
              };
              soulBinderLevelTwoPowerPerTickRF = lib.mkOption {
                type = lib.types.int;
                default = 1000;
                description = "The number of RF/t consumed by a soul binder with a double layer capacitor upgrade.";
              };
