                ...
                type = lib.types.submodule {
                  options = {
                    ...
                    enableCofhPatch = lib.mkOption {
                      type = lib.types.bool;
                      default = true;
                      description = "Enable/Disable COFH OreDictionaryArbiter Patch (Useful for Development) [default: true]";
                    };
                    enableOreDictPatch = lib.mkOption {
                      type = lib.types.bool;
                      default = false;
                      description = "Enable/Disable Forge OreDictionary Patch (Useful for Development) [default: false]";
                    };
                  };
                };
              };
                ...
                type = lib.types.submodule {
                  options = {
                    enableTcAspectSafety = lib.mkOption {
                      type = lib.types.bool;
                      default = true;
                      description = "Fixes small oversights in Thaumcraft 4. [default: true]";
                    };
                    enabledLwjglKeybindingFix = lib.mkOption {
                      type = lib.types.bool;
                      default = true;
                      description = "Prevents the game crashing from having invalid keybinds. https://github.com/alkcorp/GTplusplus/issues/544 [default: true]";
                    };
                  };
                };
              };
