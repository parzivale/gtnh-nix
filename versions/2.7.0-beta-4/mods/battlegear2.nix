          ...
          type = lib.types.submodule {
            options = {
              ...
              "Disabled Items" = lib.mkOption {
                ...
                default = [ ];
                description = "This will disable completely the provided item, along with their renderers and recipes including them. These should all be placed on separate lines between the provided '<' and '>'. The valid values are: heraldric, chain, quiver, dagger, waraxe, mace, spear, shield, knight.armour, mb.arrow, flagpole,";
              };
              "Disabled Recipies" = lib.mkOption {
                type = lib.types.listOf lib.types.str;
                default = [ ];
                description = "This will disable the crafting recipe for the provided item/blocks. It should be noted that this WILL NOT remove the item from the game, it will only disable the recipe. In this way the items may still be obtained through creative mode and cheats, but players will be unable to craft them. These should all be placed on separate lines between the provided '<' and '>'. The valid values are: chain, quiver, dagger, waraxe, mace, spear, shield, knight.armour, flagpole, mb.arrow.explosive, mb.arrow.ender, mb.arrow.flame, mb.arrow.piercing, mb.arrow.poison, mb.arrow.mystery, mb.arrow.leech, chain.armour";
              };
