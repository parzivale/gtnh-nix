...
Possible values: [MoonLander, LandingBalloons, AsteroidsLander]
[default: AsteroidsLander]";
              };
          ...
          multiblocks = lib.mkOption {
            ...
            type = lib.types.submodule {
              options = {
              DEHPDirectSteam = lib.mkOption {
                type = lib.types.bool;
                default = false;
                description = "This switch enables the Direct Steam Mode of the DEHP. If enabled it will take in Waterand output steam. If disabled it will Input IC2Coolant and output hot coolant [default: false]";
              };
              ...
              voidMinerBlacklist = lib.mkOption {
                ...
                default = [ ];
                description = "This is a blacklist for the Void Miner, blacklisted ores will not enter the drop prize pool.
