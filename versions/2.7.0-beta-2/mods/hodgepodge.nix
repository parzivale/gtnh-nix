      ...
      fixes = lib.mkOption {
        ...
        type = lib.types.submodule {
          ...
          fixIc2Hazmat = lib.mkOption {
            type = lib.types.bool;
            default = true;
            description = "Fix IC2 armors to avoid giving poison [default: true]";
          };
      ...
      pollution = lib.mkOption {
        ...
        type = lib.types.submodule {
          ...
          cokeOvenPollutionAmount = lib.mkOption {
            type = lib.types.int;
            default = 10;
            description = "Pollution Amount for Coke Ovens [range: -2147483648 ~ 2147483647, default: 3]";
          };
          explosionPollutionAmount = lib.mkOption {
            type = lib.types.str;
            default = "333.34";
            description = "Explosion pollution [range: 1.4E-45 ~ 3.4028235E38, default: 33.34]";
          };
          fireboxPollutionAmount = lib.mkOption {
            type = lib.types.int;
            default = 20;
            description = "Pollution Amount for RC Firebox [range: -2147483648 ~ 2147483647, default: 15]";
          };
          ...
          rocketPollutionAmount = lib.mkOption {
            type = lib.types.int;
            default = 10000;
            description = "Pollution Amount for Rockets [range: -2147483648 ~ 2147483647, default: 1000]";
          };
