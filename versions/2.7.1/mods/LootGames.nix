              ...
              stage_1 = lib.mkOption {
                ...
                type = lib.types.submodule {
                  ...
                  per_dim_configs = lib.mkOption {
                    ...
                    default = [ ];
                    description = "Here you can add different loot tables to each dimension. If dimension isn't in this list, then game will take default loot table for this stage.
