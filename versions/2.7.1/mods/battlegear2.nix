      ...
      general = lib.mkOption {
        ...
        type = lib.types.submodule {
          ...
          "Disabled Items" = lib.mkOption {
            ...
            default = [ ];
            description = "This will disable completely the provided item, along with their renderers and recipes including them.
...
flagpole,";
          ...
          "Disabled Recipies" = lib.mkOption {
            type = lib.types.listOf lib.types.str;
            default = [ ];
            description = "This will disable the crafting recipe for the provided item/blocks.
      ...
      rendering = lib.mkOption {
        ...
        type = lib.types.submodule {
          ...
          "Disabled Renderers" = lib.mkOption {
            type = lib.types.listOf lib.types.str;
            default = [ ];
            description = "This will disable the special rendering for the provided item.
These should all be placed on separate lines between the provided '<' and '>'.
The valid values are:
