      ...
      general = lib.mkOption {
        ...
        type = lib.types.submodule {
          ...
          buttonColor = lib.mkOption {
            type = lib.types.str;
            default = "#FFFFFFFF";
            description = "The color of the sort button in hex format (e.g. #FFFFFFFF or 0xFFFFFFFF). [default: #FFFFFFFF]";
          };
          ...
          enableHotbarSort = lib.mkOption {
            type = lib.types.bool;
            default = true;
            description = "Enable the hotbar sort feature. [default: true]";
          };
