      ...
      "entity items" = lib.mkOption {
        ...
        type = lib.types.submodule {
          ...
          newBoatEntityBlacklist = lib.mkOption {
            ...
            default = [ ];
            description = "What entities shouldn't be able to sit in the boat? This is ONLY for new boats. You can either provide an entity ID (modid.entityid, for vanilla entities type just entity ID), or search for a string in the classpath (classpath:stringtofind).
      ...
      "natural blocks" = lib.mkOption {
        ...
        type = lib.types.submodule {
          ...
          masterNetherToggle = lib.mkOption {
            type = lib.types.bool;
            default = true;
            description = "NOTE: Currently the content below is referring to some things which are behind an experimental toggle.
...
Mofified Client Classes: net.minecraft.client.particle.EffectRenderer [default: true]";
          ...
          colorGrassBlockItemSides = lib.mkOption {
            type = lib.types.bool;
            default = true;
            description = "Grass block sides are colored in the player's inventory
      ...
      rple = lib.mkOption {
        ...
        type = lib.types.submodule {
          ...
          soulFireColor = lib.mkOption {
            type = lib.types.int;
            default = 1178;
            description = "The color of soul fire. Needs to be a separate option because it's a mixin for fire and not a meta state.
Does not have any effect on the color of soul lanterns or soul torches. Check the RPLE colors config for those. [range: 0 ~ 4095, default: 1178]";
          };
          };
        };
      };
