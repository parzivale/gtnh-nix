          ...
          fix_forge_chat_link_crash = lib.mkOption {
            ...
            type = lib.types.submodule {
              ...
              _enabled = lib.mkOption {
                type = lib.types.str;
                default = "true";
                description = "Fixes crash when certain invalid URLs appear in chat.
          ...
          fix_heightmap_range = lib.mkOption {
            ...
            type = lib.types.submodule {
              ...
              _enabled = lib.mkOption {
                type = lib.types.str;
                default = "true";
                description = "Fixes heightmap calculation not including the top layer of 16x16x16 regions, causing lighting errors (MC-7508)
          ...
          exclude_library_transformation = lib.mkOption {
            ...
            type = lib.types.submodule {
              ...
              excludeLibraryTransformationPackages = lib.mkOption {
                ...
                description = "Packages that should be added as class transformer exclusions.
          ...
          jar_discoverer_cache = lib.mkOption {
            ...
            type = lib.types.submodule {
              ...
              _enabled = lib.mkOption {
                type = lib.types.str;
                default = "true";
                description = "Cache jar discoverer results (and fix a memory leak as a nice bonus).
          ...
          optimize_get_pending_block_updates = lib.mkOption {
            ...
            type = lib.types.submodule {
              ...
              _enabled = lib.mkOption {
                type = lib.types.str;
                default = "true";
                description = "Optimizes WorldServer#getPendingBlockUpdates. Speeds up chunk unloading.
              ...
              full = lib.mkOption {
                ...
                type = lib.types.submodule {
                  ...
                  badClasses = lib.mkOption {
                    ...
                    description = "Sometimes caching classes can cause problems. Classes in this list will not be cached.
[default: net.eq2online.macros.permissions.MacroModPermissions]";
                  };
                  badTransformers = lib.mkOption {
                    ...
                    description = "Comma-separated list of transformers for which the view of the transformer chain should be restored.
...
[default: org.spongepowered.asm.mixin.transformer.Proxy,appeng.transformer.asm.ApiRepairer,com.mumfrey.liteloader.transformers.ClassOverlayTransformer+]";
                  ...
                  modFilesToIgnore = lib.mkOption {
                    ...
                    description = "Comma-separated list of mod files to ignore modifications of when deciding if a cache rebuild should be triggered.
If your cache keeps getting rebuilt even though you haven't changed any mods, look for deranged mod files and add them to this list. [default: CMD files.jar]";
                  ...
                  recentCacheSize = lib.mkOption {
                    type = lib.types.int;
                    default = 512;
                    description = "Cached class bytecode is removed from memory after being used, but the most recent N are kept around because the same class is often transformed more than once. This option sets the value of that N.
(Set to -1 to keep class bytecode in RAM forever) [range: -1 ~ 2147483647, default: 512]";
                  };
                  verbosity = lib.mkOption {
                    type = lib.types.int;
                    default = 1;
                    description = "* 0: Only print the essential messages.
              ...
              lite = lib.mkOption {
                ...
                type = lib.types.submodule {
                  ...
                  useDiffsInTransformerCache = lib.mkOption {
                    type = lib.types.bool;
                    default = true;
                    description = "Only store the difference made by a transformation rather than the entire result.
...
Disable this if you want to maximize speed at the cost of increased disk and memory usage. [default: true]";
              ...
              transformerCacheMode = lib.mkOption {
                type = lib.types.str;
                default = "LITE";
                description = "The type of transformer caching to use.
          ...
          crash_handler = lib.mkOption {
            ...
            type = lib.types.submodule {
              ...
              _enabled = lib.mkOption {
                type = lib.types.str;
                default = "false";
                description = "Lets you survive crashes without the game exiting, usually.
          ...
          tweak_cloud_height_check = lib.mkOption {
            ...
            type = lib.types.submodule {
              ...
              _enabled = lib.mkOption {
                type = lib.types.str;
                default = "true";
                description = "If enabled, the condition used to decide whether to render opaque or transparent clouds will be set based on the value of `cloudHeightCheckMode`.
