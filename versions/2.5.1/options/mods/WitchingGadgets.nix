          ...
          type = lib.types.submodule {
            options = {
              ...
              "Not Trippling Cluster List" = lib.mkOption {
                ...
                default = [ "Infinity" "Infinity Catalyst" "Neutronium" "Indium" "Iridium" "Osmium" "Naquadah" "Niobium" "Americium" "Uranium" "Uranium 235" "Thorium" "Deep Iron" "Naquadria" "Plutonium" "Plutonium 241" "Europium" "Tungsten" "Black Plutonium" "Cosmic Neutronium" "Titanium" "Trinium" "Yttrium" "Platinum" "Draconium" "Oriharukon" "Samarium" "Electrum" "Curium" "Californium" "Flerovium" "Desh" "Ichorium" "Infused Gold" "Palladium" "Quantium" "Lutetium" "Mysterious Crystal" "Tellurium" "Barium" "Lanthanum" "Cerium" "Praseodymium" "Gadolinium" "Dysprosium" "Holmium" "Erbium" "Thulium" "Ytterbium" ];
              };
            };
          };
        };
