      ...
      defaults = lib.mkOption {
        ...
        type = lib.types.submodule {
          ...
          dormantChunkCacheSize = lib.mkOption {
            type = lib.types.int;
            default = 0;
            description = "Unloaded chunks can first be kept in a dormant cache for quicker
loading times. Specify the size (in chunks) of that cache here";
          ...
          maximumChunksPerTicket = lib.mkOption {
            type = lib.types.int;
            default = 25;
            description = "The default maximum number of chunks a mod can force, per ticket,
for a mod without an override. This is the maximum number of chunks a single ticket can force.";
          };
          maximumTicketCount = lib.mkOption {
            type = lib.types.int;
            default = 200;
            description = "The default maximum ticket count for a mod which does not have an override
