          ...
          color = lib.mkOption {
            ...
            type = lib.types.submodule {
              ...
              ColorThresholds = lib.mkOption {
                ...
                default = [ 30.0 70.0 ];
                description = "List of numbers in ascending order from 0-100 that set the thresholds for durability color mapping. Colors are the list of colors in ThreeColors
