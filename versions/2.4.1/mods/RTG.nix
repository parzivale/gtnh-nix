          ...
          type = lib.types.submodule {
            options = {
              ...
              "Allow bark-covered logs" = lib.mkOption {
                type = lib.types.bool;
                default = true;
                description = "Set this to FALSE to prevent the trunks of RTG trees from using the 'all-bark' texture model. For more information, visit http://minecraft.gamepedia.com/Wood#Block_data [default: true]";
              };
            };
          };
        };
