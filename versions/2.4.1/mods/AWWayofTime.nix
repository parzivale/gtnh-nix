      ...
      "rune overrides" = lib.mkOption {
        ...
        type = lib.types.submodule {
          ...
          fifthTier = lib.mkOption {
            type = lib.types.listOf lib.types.str;
            default = [ "AWWayofTime:AlchemicalWizardrybloodRune:0" "AWWayofTime:speedRune:0" "AWWayofTime:efficiencyRune:0" "AWWayofTime:runeOfSacrifice:0" "AWWayofTime:runeOfSelfSacrifice:0" "AWWayofTime:AlchemicalWizardrybloodRune:1" "AWWayofTime:AlchemicalWizardrybloodRune:2" "AWWayofTime:AlchemicalWizardrybloodRune:3" "AWWayofTime:AlchemicalWizardrybloodRune:4" "AWWayofTime:AlchemicalWizardrybloodRune:5" ];
          };
          ...
          specialBlocks = lib.mkOption {
            type = lib.types.listOf lib.types.str;
            default = [ "dreamcraft:tile.BloodyThaumium:0" "minecraft:glowstone:0" "dreamcraft:tile.BloodyVoid:0" "AWWayofTime:largeBloodStoneBrick:0" "minecraft:beacon:0" "dreamcraft:tile.BloodyIchorium:0" "AWWayofTime:blockCrystal:0" ];
          };
