...
set to false if apiaries should output all items regardless of side a pipe is attached to";
      ...
      "beekeeping.flowers.custom" = lib.mkOption {
        type = lib.types.str;
        default = "";
        description = "add additional flower blocks for apiaries here in the format modid:name or modid:name:meta. separate blocks using ';'. wildcard for metadata: '*'. will be treated like vanilla flowers. not recommended for flowers implemented as tile entities.";
      };
...
change beekeeping modes here. possible values EASY, NORMAL, HARD, HARDCORE, INSANE. mods may add additional modes.";
      ...
      "beekeeping.secondprincess" = lib.mkOption {
        ...
        default = 0.0;
        description = "percent chance of second princess drop, for limited/skyblock maps. Acceptable values up to 2 decimals.";
      };
        ...
        type = lib.types.submodule {
          ...
          builder = lib.mkOption {
            ...
            type = lib.types.submodule {
              ...
              "item.stacks" = lib.mkOption {
                type = lib.types.listOf lib.types.str;
                default = [ "Forestry:candle" "Forestry:stump" "Railcraft:anvil" "Railcraft:brick.abyssal" "Railcraft:brick.bleachedbone" "Railcraft:brick.bloodstained" "Railcraft:brick.frostbound" "Railcraft:brick.infernal" "Railcraft:brick.nether" "Railcraft:brick.quarried" "Railcraft:brick.sandy" "Railcraft:cube:1" "Railcraft:cube:8" "Railcraft:frame" "Railcraft:glass" "Railcraft:lantern.metal:0" "Railcraft:lantern.metal:1" "Railcraft:lantern.metal:2" "Railcraft:lantern.metal:3" "Railcraft:lantern.metal:4" "Railcraft:lantern.metal:5" "Railcraft:lantern.stone:0" "Railcraft:lantern.stone:1" "Railcraft:lantern.stone:2" "Railcraft:lantern.stone:3" "Railcraft:lantern.stone:4" "Railcraft:lantern.stone:5" "Railcraft:lantern.stone:6" "Railcraft:lantern.stone:7" "Railcraft:lantern.stone:8" "Railcraft:lantern.stone:9" "Railcraft:post" "Railcraft:post.metal" "Railcraft:post.metal.platform" "Railcraft:slab:0" "Railcraft:slab:1" "Railcraft:slab:10" "Railcraft:slab:11" "Railcraft:slab:12" "Railcraft:slab:13" "Railcraft:slab:14" "Railcraft:slab:15" "Railcraft:slab:16" "Railcraft:slab:17" "Railcraft:slab:18" "Railcraft:slab:19" "Railcraft:slab:2" "Railcraft:slab:20" "Railcraft:slab:21" "Railcraft:slab:22" "Railcraft:slab:23" "Railcraft:slab:24" "Railcraft:slab:25" "Railcraft:slab:26" "Railcraft:slab:27" "Railcraft:slab:28" "Railcraft:slab:29" "Railcraft:slab:30" "Railcraft:slab:31" "Railcraft:slab:32" "Railcraft:slab:33" "Railcraft:slab:34" "Railcraft:slab:35" "Railcraft:slab:36" "Railcraft:slab:37" "Railcraft:slab:38" "Railcraft:slab:39" "Railcraft:slab:40" "Railcraft:slab:41" "Railcraft:slab:42" "Railcraft:slab:43" "Railcraft:slab:5" "Railcraft:slab:6" "Railcraft:slab:7" "Railcraft:slab:8" "Railcraft:slab:9" "Railcraft:stair:0" "Railcraft:stair:1" "Railcraft:stair:10" "Railcraft:stair:11" "Railcraft:stair:12" "Railcraft:stair:13" "Railcraft:stair:14" "Railcraft:stair:15" "Railcraft:stair:16" "Railcraft:stair:17" "Railcraft:stair:18" "Railcraft:stair:19" "Railcraft:stair:2" "Railcraft:stair:20" "Railcraft:stair:21" "Railcraft:stair:22" "Railcraft:stair:23" "Railcraft:stair:24" "Railcraft:stair:25" "Railcraft:stair:26" "Railcraft:stair:27" "Railcraft:stair:28" "Railcraft:stair:29" "Railcraft:stair:30" "Railcraft:stair:31" "Railcraft:stair:32" "Railcraft:stair:33" "Railcraft:stair:34" "Railcraft:stair:35" "Railcraft:stair:36" "Railcraft:stair:37" "Railcraft:stair:38" "Railcraft:stair:39" "Railcraft:stair:40" "Railcraft:stair:41" "Railcraft:stair:42" "Railcraft:stair:43" "Railcraft:stair:5" "Railcraft:stair:6" "Railcraft:stair:7" "Railcraft:stair:8" "Railcraft:stair:9" "Railcraft:wall.alpha:0" "Railcraft:wall.alpha:1" "Railcraft:wall.alpha:10" "Railcraft:wall.alpha:11" "Railcraft:wall.alpha:12" "Railcraft:wall.alpha:13" "Railcraft:wall.alpha:14" "Railcraft:wall.alpha:15" "Railcraft:wall.alpha:2" "Railcraft:wall.alpha:3" "Railcraft:wall.alpha:4" "Railcraft:wall.alpha:5" "Railcraft:wall.alpha:6" "Railcraft:wall.alpha:7" "Railcraft:wall.alpha:8" "Railcraft:wall.alpha:9" "Railcraft:wall.beta:0" "Railcraft:wall.beta:1" "Railcraft:wall.beta:2" "Railcraft:wall.beta:3" "Railcraft:wall.beta:4" "Railcraft:wall.beta:5" "Railcraft:wall.beta:6" "Railcraft:wall.beta:7" "Railcraft:wall.beta:8" "minecraft:brick_block:0" "minecraft:clay:0" "minecraft:crafting_table:0" "minecraft:dispenser:0" "minecraft:dropper:0" "minecraft:furnace:0" "minecraft:hardened_clay" "minecraft:iron_bars:0" "minecraft:item_frame:0" "minecraft:ladder:0" "minecraft:lever:0" "minecraft:nether_brick:0" "minecraft:packed_ice:0" "minecraft:quartz_block" "minecraft:redstone_lamp:0" "minecraft:redstone_torch:0" "minecraft:sandstone:1" "minecraft:sandstone:2" "minecraft:sign:0" "minecraft:stained_hardened_clay" "minecraft:stonebrick" "minecraft:torch:0" ];
          ...
          digger = lib.mkOption {
            ...
            type = lib.types.submodule {
              ...
              "item.stacks" = lib.mkOption {
                type = lib.types.listOf lib.types.str;
                default = [ "BiomesOPlenty:ash" "BiomesOPlenty:ash:0" "BiomesOPlenty:bopGrass" "BiomesOPlenty:hardDirt" "BiomesOPlenty:hardDirt:0" "BiomesOPlenty:hardSand" "BiomesOPlenty:hardSand:0" "BiomesOPlenty:longGrass" "BiomesOPlenty:longGrass:0" "BiomesOPlenty:mud" "BiomesOPlenty:mud:0" "BiomesOPlenty:newBopDirt" "BiomesOPlenty:newBopGrass" "BiomesOPlenty:originGrass" "BiomesOPlenty:originGrass:0" "Forestry:brokenBronzeShovel:0" "Forestry:bronzeShovel:0" "Forestry:kitShovel:0" "Railcraft:cube:6" "Railcraft:cube:7" "chisel:andesite:0" "chisel:diorite:0" "chisel:granite:0" "chisel:limestone:0" "chisel:marble:0" "minecraft:clay_ball:0" "minecraft:dirt" "minecraft:flint:0" "minecraft:gravel:0" "minecraft:netherrack:0" "minecraft:sandstone:0" "minecraft:soul_sand:0" "appliedenergistics2:tile.BlockSkyStone" "appliedenergistics2:tile.BlockSkyStone:1" ];
...
set to false to disable crafting recipe for bronze";
      ...
      "crafting.stamps.collector" = lib.mkOption {
        type = lib.types.str;
        default = "";
        description = "if crafting of stamps is generally allowed, these stamps are still excluded from crafting.";
      };
      "crafting.stamps.enabled" = lib.mkOption {
        type = lib.types.bool;
        default = true;
        description = "set to false to disable crafting recipes for all types of stamps.";
      };
      "difficulty.dungeonloot.rare" = lib.mkOption {
        type = lib.types.bool;
        default = false;
        description = "set to true to make dungeon loot generated by forestry rarer";
      };
...
set to your preferred game mode. available modes are OP, EASY, NORMAL, HARD. mismatch with the server may cause visual glitches with recipes. setting an unavailable mode will create a new mode definition file.";
      ...
      "difficulty.recreate.definitions" = lib.mkOption {
        type = lib.types.bool;
        default = false;
        description = "set to true to force recreation of the game mode definitions in config/forestry/gamemodes";
      };
...
set to true to clear chromosomes which contain invalid alleles. might rescue your save if it is crashing after the removal of a bee addon.";
      ...
      "performance.backpacks.resupply" = lib.mkOption {
        type = lib.types.bool;
        default = true;
        description = "leaving this enabled will cycle the list of active players PER INGAME TICK to check for resupply via backpack. you want to set this to false on busy servers.";
      };
...
add schemata keys to disable them. current keys: alveary3x3;farm3x3;farm3x4;farm3x5;farm4x4;farm5x5";
      ...
      "tweaks.energystat.disabled" = lib.mkOption {
        type = lib.types.bool;
        default = true;
        description = "set to true to disable energy statistics on energy consumers.";
      };
      "tweaks.farms.exutilenderlily" = lib.mkOption {
        type = lib.types.bool;
        default = false;
        description = "set to false to disable multifarm support for ExtraUtilities Ender-lily seeds.";
      };
      "tweaks.farms.magicalcropssupport" = lib.mkOption {
        type = lib.types.bool;
        default = false;
        description = "set to false to disable multifarm support for Magical Crops crops.";
      };
      "tweaks.farms.squared" = lib.mkOption {
        type = lib.types.bool;
        default = false;
        description = "set to true to have farms use a square layout instead of a diamond one.";
      };
      "tweaks.gui.tab.speed" = lib.mkOption {
        type = lib.types.int;
        default = 8;
        description = "set the speed at which the gui side tabs open and close.";
      };
      "tweaks.hints.disabled" = lib.mkOption {
        type = lib.types.bool;
        default = false;
        description = "set to true to disable hints on machine and engine guis.";
      };
...
set to false to disable the mail alert box";
      ...
      "tweaks.permissions.disabled" = lib.mkOption {
        type = lib.types.bool;
        default = false;
        description = "set to true to disable access restrictions on forestry machines.";
      };
      "tweaks.tooltip.liquidamount.disabled" = lib.mkOption {
        type = lib.types.bool;
        default = false;
        description = "set to true to disable displaying liquid amounts in tank tooltips.";
      };
      "tweaks.upgradenotice.disabled" = lib.mkOption {
        type = lib.types.bool;
        default = false;
        description = "set to true to disable update and version check notice.";
      };
      "world.generate.apatite" = lib.mkOption {
        type = lib.types.bool;
        default = false;
        description = "set to false to force forestry to skip generating own apatite ore blocks in the world";
      };
      "world.generate.beehives" = lib.mkOption {
        type = lib.types.bool;
        default = true;
        description = "set to false to force forestry to skip generating beehives in the world";
      };
      "world.generate.beehives.rate" = lib.mkOption {
        type = lib.types.float;
        default = 1.0;
        description = "set how many beehives spawn. Default is 1.0, double is 2.0, half is 0.5 etc.";
      };
      "world.generate.copper" = lib.mkOption {
        type = lib.types.bool;
        default = false;
        description = "set to false to force forestry to skip generating own copper ore blocks in the world";
      };
      "world.generate.tin" = lib.mkOption {
        type = lib.types.bool;
        default = false;
        description = "set to false to force forestry to skip generating own tin ore blocks in the world";
      };
      "world.generate.villager" = lib.mkOption {
        type = lib.types.bool;
        default = true;
        description = "set to false to disable the creation of forestry villagers and their houses";
      };
      "world.retrogen.forced" = lib.mkOption {
        type = lib.types.bool;
        default = false;
        description = "Set to true, Forestry will attempt worldGen in all chunks for this game instance. Config option will be set to false after this run.";
      };
      ...
      enablefluid = lib.mkOption {
        ...
        type = lib.types.submodule {
          ...
          mead = lib.mkOption {
            type = lib.types.bool;
            default = true;
            description = "Enables fluid.mead fluid. [default: true]";
          };
          milk = lib.mkOption {
            type = lib.types.bool;
            default = true;
      ...
      enablefluidblock = lib.mkOption {
        ...
        type = lib.types.submodule {
          ...
          mead = lib.mkOption {
            type = lib.types.bool;
            default = true;
            description = "Enables fluid.mead in-world fluid block. [default: true]";
          };
          milk = lib.mkOption {
            type = lib.types.bool;
            default = true;
