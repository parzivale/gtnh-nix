  ...
  bartworks_cfg = lib.mkOption {
    ...
    type = lib.types.submodule {
      ...
      "asm fixes" = lib.mkOption {
        ...
        type = lib.types.submodule {
          options = {
          "DUCTTAPING RWG WORLDEN FAILS in class: rwg.world.ChunkGeneratorRealistic" = lib.mkOption {
            type = lib.types.bool;
            default = true;
          };
          ...
          "PATCHING GLOBAL RENDERER FOR USE WITH MY GALACTIC DIMS in class: net.minecraft.client.renderer.RenderGlobal" = lib.mkOption {
            type = lib.types.bool;
            default = true;
          };
          ...
          "PLACING MY GLASS-BLOCK RUNNABLE INTO THE GT_API in class: gregtech.GT_Mod" = lib.mkOption {
            type = lib.types.bool;
            default = true;
          };
          "REMOVING RAIN FROM LAST MILLENIUM (EXU) in class: com.rwtema.extrautils.worldgen.endoftime.WorldProviderEndOfTime" = lib.mkOption {
            type = lib.types.bool;
            default = true;
          };
          "REMVOING CREATURES FROM LAST MILLENIUM (EXU) in class: com.rwtema.extrautils.worldgen.endoftime.ChunkProviderEndOfTime" = lib.mkOption {
            type = lib.types.bool;
            default = true;
          };
          };
