          ...
          type = lib.types.submodule {
            options = {
              ...
              ItemList = lib.mkOption {
                type = lib.types.listOf lib.types.str;
                default = [ "Avaritia:Endest_Pearl;0;-1;1;7;" "gregtech:gt.metaitem.01:32405;" "gregtech:gt.metaitem.01:32406;" "gregtech:gt.metaitem.01:32407;" "gregtech:gt.metaitem.01:32408;" "gregtech:gt.metaitem.01:32409;" "gregtech:gt.metaitem.01:32410;" "gregtech:gt.metaitem.01:32411;" "gregtech:gt.metaitem.01:32412;" "gregtech:gt.metaitem.01:32413;" "TConstruct:buckets:24;0;-1;1;7;" "IguanaTweaksTConstruct:clayBucketsTinkers:24;0;-1;1;7;" "TwilightForest:item.tfspawnegg:182;0;-1;1;26;27;28;29;30;" "TwilightForest:item.tfspawnegg:189;0;-1;1;26;27;28;29;30;" "TwilightForest:item.tfspawnegg:190;0;-1;1;26;27;28;29;30;" "TwilightForest:item.tfspawnegg:205;0;-1;1;26;27;28;29;30;" "TwilightForest:item.tfspawnegg:217;0;-1;1;26;27;28;29;30;" "TwilightForest:item.tfspawnegg:224;0;-1;1;26;27;28;29;30;" "TwilightForest:item.tfspawnegg:226;0;-1;1;26;27;28;29;30;" "TwilightForest:item.tfspawnegg:231;0;-1;1;26;27;28;29;30;" ];
          ...
          type = lib.types.submodule {
            options = {
              PotionTimer = lib.mkOption {
                type = lib.types.int;
                default = 200;
                description = "The time (in ticks) the potion effect will remain on the player when he drops the bucket. 20 = 1 second [range: 100 ~ 2048, default: 100]";
              };
            };
          };
        };
          ...
          type = lib.types.submodule {
            options = {
              ...
              HoverModeFixEnabled = lib.mkOption {
                type = lib.types.bool;
                default = true;
                description = "Set to true to prevent gravisuit advanced nano chest plate and advanced jetpack from falling when idle under hover mode. [default: true]";
              };
          ...
          type = lib.types.submodule {
            options = {
              ...
              ItemInHandInfo = lib.mkOption {
                type = lib.types.bool;
                default = true;
                description = "Set to true to enable ItemInHandInfo module. If enabled, type /iih to display the item's name-info [default: false]";
              };
              ...
              ModPackVersion = lib.mkOption {
                type = lib.types.str;
                default = "2.4.1";
                description = "Version of the Modpack [default: 2.4.1]";
              };
