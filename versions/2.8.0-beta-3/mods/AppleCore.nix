      ...
      server = lib.mkOption {
        ...
        type = lib.types.submodule {
          ...
          "exhaustion.sync.threshold" = lib.mkOption {
            ...
            default = 0.01;
            description = "The maximum difference between the server's value for exhaustion and the client's before the value is syncronized from the server to the client.
