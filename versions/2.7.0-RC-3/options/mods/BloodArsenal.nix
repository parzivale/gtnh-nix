          ...
          type = lib.types.submodule {
            options = {
              "Is RED > PURPLE?" = lib.mkOption {
                type = lib.types.bool;
                default = false;
                description = "Purple is always better than Red. But I won't tell you how to live your life. Even if it is incorrectly.";
              };
              "Is auto-magic version checking allowed?" = lib.mkOption {
                type = lib.types.bool;
                default = false;
                description = "Allows for your version to be checked against the latest version";
              };
