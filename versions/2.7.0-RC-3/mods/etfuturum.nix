      ...
      "entity items" = lib.mkOption {
        ...
        type = lib.types.submodule {
          ...
          newBoatEntityBlacklist = lib.mkOption {
            ...
            default = [ ];
            description = "What entities shouldn't be able to sit in the boat? You can either provide an entity ID (modid.entityid, for vanilla entities type just entity ID), or search for a string in the classpath (classpath:stringtofind).
...
It's a little hard to explain, a more detailed explanation and list of examples can be found here: https://pastebin.com/XNZ7VWKh";
          ...
          newBoatMaxLandSpeed = lib.mkOption {
            type = lib.types.str;
            default = "0.986";
            description = "The maximum speed a boat can travel by while on land. This option exists because boats are very very fast when travelling on slippery blocks. Land speed = 0.6, Regular/Packed Ice Speed = 0.98, Packed Ice Speed = 0.986. Anything smaller than 0.6 is really, REALLY slow on land.
      ...
      equipment = lib.mkOption {
        ...
        type = lib.types.submodule {
          ...
          netheriteArmourDurabilityFactor = lib.mkOption {
            type = lib.types.int;
            default = 37;
            description = "[range: 1 ~ 2147483647, default: 37]";
          };
          netheriteAxeDurability = lib.mkOption {
            type = lib.types.int;
            default = -1;
            description = "Override Netherite Axe Durability, -1 to disable [range: -1 ~ 2147483647, default: -1]";
          };
          ...
          netheriteDamageBase = lib.mkOption {
            type = lib.types.str;
            default = "4.0";
            description = "Neterite base damage, Diamond is 3.0 [range: 0.0 ~ 3.4028235E38, default: 4.0]";
          };
          ...
          netheriteHelmetDurability = lib.mkOption {
            type = lib.types.int;
            default = -1;
            description = "Override Netherite Helmet Durability, -1 to disable [range: -1 ~ 2147483647, default: -1]";
          };
          ...
          netheriteHoeDurability = lib.mkOption {
            type = lib.types.int;
            default = -1;
            description = "Override Netherite Hoe Durability, -1 to disable [range: -1 ~ 2147483647, default: -1]";
          };
          ...
          netheritePickaxeDurability = lib.mkOption {
            type = lib.types.int;
            default = -1;
            description = "Override Netherite Pickaxe Durability, -1 to disable [range: -1 ~ 2147483647, default: -1]";
          };
          netheriteSpadeDurability = lib.mkOption {
            type = lib.types.int;
            default = -1;
            description = "Override Netherite Shovel Durability, -1 to disable [range: -1 ~ 2147483647, default: -1]";
          };
          netheriteSpeed = lib.mkOption {
            type = lib.types.str;
            default = "9.0";
            description = "Netherite mining speed, Diamond is 8.0 [range: 0.1 ~ 3.4028235E38, default: 9.0]";
          };
          netheriteSwordDurability = lib.mkOption {
            type = lib.types.int;
            default = -1;
            description = "Override Netherite Sword Durability, -1 to disable [range: -1 ~ 2147483647, default: -1]";
          };
      ...
      "function blocks" = lib.mkOption {
        ...
        type = lib.types.submodule {
          ...
          enableBlastFurnace = lib.mkOption {
            type = lib.types.bool;
            default = true;
            description = "Will attempt to seek and auto-add recipes to itself. Look at ConfigFunctions.cfg \"autoAddBlastFurance\" for more info.
Compatible with CraftTweaker. In the same way that you'd use furnace.addRecipe or furnace.remove, you can use \"mods.etfuturum.blastFurnace\" instead of \"furnace\". [default: true]";
          ...
          enableComposter = lib.mkOption {
            type = lib.types.bool;
            default = true;
            description = "Allows certain items to be composted, which has a chance of adding a layer to the compost bin. Once full, bone meal may be harvested. It is compatible with CraftTweaker.
...
By default bone meal is the only item in this loot table, with a weight of 10. You can learn more about CraftTweaker loot table modification here: https://www.mcdrama.net/archiveformal/MineTweaker3/wiki/tutorials/1710/loot_and_seeds.html [default: true]";
          ...
          enableDoors = lib.mkOption {
            type = lib.types.bool;
            default = false;
            description = "Enables wood variant doors [default: true]";
          };
          ...
          enableNewBrewingStand = lib.mkOption {
            type = lib.types.bool;
            default = true;
            description = "Makes the brewing stand have a fuel slot like in 1.9+. The fuel slot is compatible with CraftTweaker and takes blaze powder by default. Blaze powder can brew 30 potion cycles.
...
mods.etfuturum.brewingFuel.remove(<minecraft:blaze_powder>); //(Removes blaze powder as a brewing fuel) [default: true]";
          ...
          enableNewEnchantingTable = lib.mkOption {
            type = lib.types.bool;
            default = true;
            description = "Uses lapis as payment and has enchant previews and adjusted level costs. Requires tile entity replacement to be enabled in \"function.cfg\". It is compatible with CraftTweaker for adding and removing fuels.
...
mods.etfuturum.enchantingFuel.remove(<minecraft:dye:4>); //(Removes lapis lazuli as an enchanting fuel) [default: true]";
          ...
          enableSmithingTable = lib.mkOption {
            type = lib.types.bool;
            default = true;
            description = "If this is disabled, netherite items will not be craftable unless added by CraftTweaker. This introduces the smithing GUI from versions prior to 1.20. It is compatible with CraftTweaker.
...
mods.etfuturum.smithingTable.addRecipeNoNBT(<etfuturum:sponge:1>, <minecraft:sponge>, <minecraft:water_bucket>); //Take a vanilla sponge and a water bucket, you will get an Et Futurum Requiem wet sponge. [default: true]";
          ...
          enableSmoker = lib.mkOption {
            type = lib.types.bool;
            default = true;
            description = "Will attempt to seek and auto-add recipes to itself. Look at ConfigFunctions.cfg \"autoAddSmoker\" for more info.
Compatible with CraftTweaker. In the same way that you'd use furnace.addRecipe or furnace.remove, you can use \"mods.etfuturum.smoker\" instead of \"furnace\". [default: true]";
          ...
          enableTrapdoors = lib.mkOption {
            type = lib.types.bool;
            default = false;
            description = "Enables wood variant trapdoors [default: true]";
          };
          enableWoodRedstone = lib.mkOption {
            type = lib.types.bool;
            default = true;
            description = "Enables wood variant buttons and pressure plates [default: true]";
          };
          };
        };
      };
      "misc blocks" = lib.mkOption {
        ...
        type = lib.types.submodule {
          ...
          enableFences = lib.mkOption {
            type = lib.types.bool;
            default = true;
            description = "Enables wood variant fences. [default: true]";
          };
          enableGates = lib.mkOption {
            type = lib.types.bool;
            default = false;
            description = "Enables wood variant gates. [default: true]";
          };
      ...
      "natural blocks" = lib.mkOption {
        ...
        type = lib.types.submodule {
          options = {
          deepslateHardness = lib.mkOption {
            type = lib.types.str;
            default = "2.3333333333";
            description = "Set how hard deepslate is, in case you like the look of deepslate but don't want to deal with the additional hardness. Regular stone is 1.5. [range: 0.0 ~ 100.0, default: 3.0]";
          };
          ...
          masterNetherToggle = lib.mkOption {
            type = lib.types.bool;
            default = true;
            description = "Set this to false to easily turn off all Nether blocks. This also turns off all Nether biomes because they require the blocks to generate.
      ...
      "experimental features -- tread carefully" = lib.mkOption {
        ...
        type = lib.types.submodule {
          ...
          enableCrimsonBlocks = lib.mkOption {
            type = lib.types.bool;
            default = false;
            description = "Enables the crimson nylium, wood, and plants. This must be on for the crimson forest biome to generate unless Netherlicious is installed.
The nether wart block is still a separate toggle, both this and the wart toggle must be turned off to disable the nether wart block, because crimson trees need the wart blocks. [default: false]";
          ...
          netherDimensionProvider = lib.mkOption {
            type = lib.types.bool;
            default = false;
            description = "Enables the Nether dimension provider override needed for supplying custom biomes. This is partially ignored if Netherlicious is installed. Netherlicious has compat to generate Et Futurum Requiem biomes with Netherlicious blocks.
      ...
      settings = lib.mkOption {
        ...
        type = lib.types.submodule {
          ...
          elytraDataWatcherFlag = lib.mkOption {
            type = lib.types.int;
            default = 7;
            description = "The data watcher flag for the Elytra, used to sync the elytra animation with other players. In vanilla the max value is 7, players use 0-4, so you can set this to 6 or 7 by default. ASJCore increases the max value to 31.
Do not change this value if you don't need to, or do not know what you're doing. [range: 0 ~ 31, default: 7]";
          ...
          registerRawItemAsOre = lib.mkOption {
            type = lib.types.bool;
            default = false;
            description = "Register the raw ore items in the OreDictionary as if they were the actual ore block. Such as raw iron being registered as an iron ore, etc...
      ...
      update_checker = lib.mkOption {
        ...
        type = lib.types.submodule {
          ...
          enableUpdateChecker = lib.mkOption {
            type = lib.types.bool;
            default = false;
            description = "Check and print a chat message in-game if there's a new update available? [default: true]";
          };
          };
        };
      };
      ...
      "backported features" = lib.mkOption {
        ...
        type = lib.types.submodule {
          ...
          adjustedAttenuation = lib.mkOption {
            type = lib.types.bool;
            default = true;
            description = "Adjusts the attenuation distance of certain sounds. This needs to be a separate mixin due to the way it works.
...
Modified Client Classes: net.minecraft.client.audio.SoundManager [default: true]";
          ...
          avoidDroppingItemsWhenClosing = lib.mkOption {
            type = lib.types.bool;
            default = false;
            description = "Experimental: avoid dropping items when closing an inventory, like in modern versions.
Modified Classes: net.minecraft.entity.player.EntityPlayerMP [default: false]";
          };
          betterPistons = lib.mkOption {
            type = lib.types.bool;
            default = true;
            description = "A port of Back in Slime, similar to how the elytra is a port of Backlytra. Allows pistons to interact with slime blocks. The original author of this is DonBruce64: https://legacy.curseforge.com/minecraft/mc-mods/back-in-slime-slime-blocks-for-1-7.
Modified Classes: net.minecraft.block.BlockPistonBase [default: true]";
          };
          blockHopperInteraction = lib.mkOption {
            type = lib.types.bool;
            default = true;
            description = "Allows some blocks without tile entities (e.g. composters) to interact with hoppers. May still not interact with modded pipes.
Modified Classes: net.minecraft.tileentity.TileEntityHopper [default: true]";
          };
          bouncyBeds = lib.mkOption {
            type = lib.types.bool;
            default = true;
            description = "Makes beds bouncy. Should work with most modded beds. For continuity disabling this also disables EFR beds being bouncy.
Modified Classes: net.minecraft.block.BlockBed [default: true]";
          };
          boundedBlockBreakingParticles = lib.mkOption {
            type = lib.types.bool;
            default = true;
            description = "In 1.14+, when breaking a block, the block break particles stay within the outline, instead of always occupying the whole block space.
Mofified Client Classes: net.minecraft.client.particle.EffectRenderer [default: true]";
          ...
          creativeFlightSpeedModifier = lib.mkOption {
            type = lib.types.str;
            default = "1.0";
            description = "When greater than 1, boosts creative flight speed when sprinting, like in newer versions [range: 1.0 ~ 4.0, default: 2.0]";
          };
          dustUnderFallingBlocks = lib.mkOption {
            type = lib.types.bool;
            default = true;
            description = "Spawns a particle under falling blocks like sand or gravel that are suspended mid-air.
Modified Classes: net.minecraft.block.BlockFalling [default: true]";
          ...
          enableElytra = lib.mkOption {
            type = lib.types.bool;
            default = true;
            description = "A port of Backlytra with various fixes. The original author of this is unascribed: https://legacy.curseforge.com/minecraft/mc-mods/backlytra
...
Modified Client Classes: net.minecraft.client.renderer.EntityRenderer net.minecraft.entity.player.EntityPlayer net.minecraft.client.renderer.WorldRenderer [default: true]";
          ...
          endPortalFix = lib.mkOption {
            type = lib.types.bool;
            default = true;
            description = "Makes the End Portal block (the actual portal, not the frame) have an item icon, proper hitbox and will not instantly destroy itself in other dimensions.
Modified classes: net.minecraft.block.BlockEndPortal [default: true]";
          };
          fenceWallConnectFix = lib.mkOption {
            type = lib.types.bool;
            default = true;
            description = "Makes vanilla fences connect to modded ones of the same material. Might have connection issue with mods that don't reference BlockFence super code.
Modified classes: net.minecraft.block.BlockFence net.minecraft.block.BlockWall [default: true]";
          ...
          floorCeilingButtons = lib.mkOption {
            type = lib.types.bool;
            default = true;
            description = "Allows ability to place buttons on the floor and ceiling. Note: Due to metadata limits, they won't rotate to face the player like how they were made to in more modern versions.
Modified Classes: net.minecraft.block.BlockButton [default: true]";
          };
          furnaceCrackle = lib.mkOption {
            type = lib.types.bool;
            default = true;
            description = "Allows vanilla furnaces to have crackling sounds.
Modified Client Classes: net.minecraft.block.BlockFurnace [default: true]";
          };
          hoeTilling = lib.mkOption {
            type = lib.types.bool;
            default = true;
            description = "Sounds for hoes tilling farmland.
Modified Classes: net.minecraft.item.ItemHoe [default: true]";
          };
          ladderTrapdoors = lib.mkOption {
            type = lib.types.bool;
            default = true;
            description = "Trapdoors that are clapped open against a block with a ladder below them can be climbed up as if they themselves were a ladder. Also expands the ladder hitbox to match the width of trapdoors.
Modified Classes: net.minecraft.block.BlockLadder net.minecraft.block.BlockTrapdoor [default: true]";
          ...
          newBeaconSounds = lib.mkOption {
            type = lib.types.bool;
            default = true;
            description = "Allows beacon ambience to play for beacons. Should include most modded beacons.
Modified Classes: net.minecraft.tileentity.TileEntityBeacon [default: true]";
          };
          newEnchantingSounds = lib.mkOption {
            type = lib.types.bool;
            default = true;
            description = "Allows an enchantment sound to play on the vanilla enchantment table, and possibly a few modded ones...? This option does nothing to the Et Futurum Requiem enchantment tables.
Modified Classes: net.minecraft.inventory.ContainerEnchantment [default: true]";
          };
          newEnderEyeSounds = lib.mkOption {
            type = lib.types.bool;
            default = true;
            description = "New sounds for throwing an eye of ender, and for them breaking or dropping.
Modified Classes: net.minecraft.entity.item.EntityEnderEye net.minecraft.item.ItemEnderEye [default: true]";
          ...
          newFishingRodSounds = lib.mkOption {
            type = lib.types.bool;
            default = true;
            description = "New sounds for casting and reeling in fishing rods.
Modified Classes: net.minecraft.item.ItemFishingRod [default: true]";
          };
          newHurtSounds = lib.mkOption {
            type = lib.types.bool;
            default = true;
            description = "Damage sounds for walking into a berry bush, drowning or burning
Modified Classes: net.minecraft.entity.player.EntityPlayer net.minecraft.client.entity.EntityClientPlayerMP [default: true]";
          ...
          postTreeGenEvent = lib.mkOption {
            type = lib.types.bool;
            default = true;
            description = "Fires an event after a tree generates, mainly for beehives to accurately know where most trees are. For now this option is disabled if bees are disabled.
Modified Classes: net.minecraft.world.gen.feature.WorldGenAbstractTree [default: true]";
          };
          soulFire = lib.mkOption {
            type = lib.types.bool;
            default = true;
            description = "Is not a new block, but rather a mixin for fire. Allows fire to stay ignited on soul soil. Does double damage when standing in it, and does not spread to other blocks.
...
Modified Client Classes: net.minecraft.client.renderer.RenderBlocks [default: true]";
          ...
          thinPanes = lib.mkOption {
            type = lib.types.bool;
            default = true;
            description = "Panes [Iron Bars, Glass Panes, etc] are changed to a single post if they are not connected to any other blocks
      ...
      fixes = lib.mkOption {
        ...
        type = lib.types.submodule {
          ...
          arrowFallingFix = lib.mkOption {
            type = lib.types.bool;
            default = true;
            description = "Prevents arrows from falling off of blocks too easily
Modified classes: net.minecraft.entity.EntityArrow [default: true]";
          };
          collidedThrowableFix = lib.mkOption {
            type = lib.types.bool;
            default = true;
            description = "Fixes EntityThrowable entities not calling onEntityCollidedWithBlock, causing them to not trigger target blocks or chime amethyst.
Modified classes: net.minecraft.entity.projectile.EntityThrowable [default: true]";
          };
          flowerPotFixes = lib.mkOption {
            type = lib.types.bool;
            default = true;
            description = "Fixes flower pots having several restrictions limiting what they'll render inside of them. Required for crimson roots or azalea to render correctly in the flower pot, among other custom blocks.
Modified Client Classes: net.minecraft.client.renderer.RenderBlock [default: true]";
          };
          hideSingleLevelEnchants = lib.mkOption {
            type = lib.types.bool;
            default = true;
            description = "Fixes enchantments with only one possible level displaying a level in their name. E.G. \"Silk Touch I\" becomes \"Silk Touch\".
Modified Classes: net.minecraft.enchantment.Enchantment [default: true]";
          };
          stepHeightFix = lib.mkOption {
            type = lib.types.bool;
            default = true;
            description = "Makes the player able to step up even if a block would be above their head at the destination.
      ...
      misc = lib.mkOption {
        ...
        type = lib.types.submodule {
          ...
          disableBaseBountifulStonesOnly = lib.mkOption {
            type = lib.types.bool;
            default = false;
            description = "Disables just the andesite, granite, and diorite full blocks, but leaves their stairs and slabs, etc enabled.
Useful if you have mods like Chisel or Botania which feature these same stones but not the stairs and other variants. [default: false]";
          ...
          disableCopperOreAndIngotOnly = lib.mkOption {
            type = lib.types.bool;
            default = true;
            description = "Disables copper ingots and ores, but leaves the blocks and other stuff.
Useful if you prefer another mod's copper, but want to use the oxidizing copper building blocks. [default: false]";
          ...
          elytraBaublesExpandedCompat = lib.mkOption {
            type = lib.types.int;
            default = 1;
            description = "Adds compat for Baubles Expanded. Does nothing for standard baubles, this REQUIRES Baubles Expanded! It uses the new \"wings\" slot added by the expanded version. https://modrinth.com/mod/baubles-expanded
...
2 = The elytra can ONLY go in the wings slots, not the chestplate slot. [range: 0 ~ 2, default: 1]";
          ...
          moddedDeepslateOresBlacklist = lib.mkOption {
            type = lib.types.listOf lib.types.str;
            default = [ ];
            description = "List of modded deepslate ores to disable. Add a ModID or ore dictionary tag. For example adding \"oreTin\" disables deepslate tin, and adding \"SimpleOres\" would disable deepslate adamantium ore. CaSe-SeNsItIvE!
Each entry is separated by a new line. This only disables deepslate ores added from Et Futurum's end and will not affect deepslate ores from other mods. [default: ]";
          ...
          moddedRawOresBlacklist = lib.mkOption {
            type = lib.types.listOf lib.types.str;
            default = [ ];
            description = "List of modded raw ores to disable. Add a ModID or ore dictionary tag. For example adding \"oreTin\" disables modded raw tin, and adding \"SimpleOres\" would disable raw adamantium ore. CaSe-SeNsItIvE!
      ...
      players = lib.mkOption {
        ...
        type = lib.types.submodule {
          ...
          armorEquipCustomRules = lib.mkOption {
            ...
            description = "Used for custom armor to play custom equip sounds. First the sound you want to play, a colon, then a part of the unlocalized name. The string can be anywhere in the unlocalized name and is not case-sensitive.
      ...
      "custom tweaks" = lib.mkOption {
        ...
        type = lib.types.submodule {
          ...
          shulkersSpawnAnywhere = lib.mkOption {
            type = lib.types.bool;
            default = false;
            description = "For compatibility reasons, you may want the Shulker to spawn anywhere in the End in random groups like Endermen. These are uncommon.
      ...
      generation = lib.mkOption {
        ...
        type = lib.types.submodule {
          ...
          amethystMiddleBlockID = lib.mkOption {
            ...
            description = "Use a namespaced ID, + optionally meta (max 15) to choose the block that makes up the middle layer of amethyst geodes.
If the chosen block does not exist then amethyst geodes will not generate. [default: etfuturum:calcite]";
          ...
          amethystOuterBlockID = lib.mkOption {
            type = lib.types.str;
            default = "etfuturum:smooth_basalt";
            description = "Use a namespaced ID, + optionally meta (max 15) to choose the block that makes up the outer layer of amethyst geodes.
...
If the chosen block does not exist then amethyst geodes will not generate. [default: etfuturum:smooth_basalt]";
          ...
          buddingAmethystMode = lib.mkOption {
            type = lib.types.int;
            default = 0;
            description = "0 = Budding amethyst cannot be obtained at all even with silk touch. When using this option, attempting to push them using a piston will break it.
...
2 = Budding amethyst does not need silk touch, just a pickaxe. [range: 0 ~ 2, default: 0]";
          ...
          fossilBlockID = lib.mkOption {
            ...
            description = "Use a namespaced ID, + optionally meta (max 3) to choose the block that makes up fossils. The max meta is 3 because the rotations will change the meta. North/South is the meta + 4 and East/West is + 8.
      ...
      miscellaneous = lib.mkOption {
        ...
        type = lib.types.submodule {
          ...
          oldHuskSpawning = lib.mkOption {
            type = lib.types.bool;
            default = false;
            description = "Enables the old husk spawning logic. Instead of replacing 80% of zombies exposed to the sky in the right biomes, they'll reduce the spawn rate of normal zombies and spawn anywhere in the correct biomes.
OptiFine breaks the sky-exposure behavior so this option will be forced on when OptiFine is detected. [default: false]";
          ...
          oldStraySpawning = lib.mkOption {
            type = lib.types.bool;
            default = false;
            description = "Enables the old stray spawning logic. Instead of replacing 80% of skeletons exposed to the sky in the right biomes, they'll reduce the spawn rate of normal skeletons and spawn anywhere in the correct biomes.
OptiFine breaks the sky-exposure behavior so this option will be forced on when OptiFine is detected. [default: false]";
          };
          tileReplacementMode = lib.mkOption {
            type = lib.types.int;
            default = 0;
            description = "Replace old Brewing Stands/Enchanting Tables/Daylight Sensors/Beacons with new one on the fly.
