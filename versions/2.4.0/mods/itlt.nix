      ...
      display = lib.mkOption {
        ...
        type = lib.types.submodule {
          ...
          useTechnicDisplayName = lib.mkOption {
            type = lib.types.bool;
            default = false;
            description = "Set to true to attempt to get the display name of the pack of the info json file
This will take priority over windowDisplayTitle";
          };
          useTechnicIcon = lib.mkOption {
            type = lib.types.bool;
            default = false;
            description = "Set to true to attempt to use the icon assigned to the modpack by the technic launcher.
