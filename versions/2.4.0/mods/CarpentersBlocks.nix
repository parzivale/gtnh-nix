      ...
      features = lib.mkOption {
        ...
        type = lib.types.submodule {
          ...
          "Cover Exceptions" = lib.mkOption {
            ...
            description = "This allows restricted blocks to be used as covers.
Add your own by supplying the display name for the block (en_US only).";
          ...
          "Enable Ownership" = lib.mkOption {
            type = lib.types.bool;
            default = true;
            description = "This will prevent players besides you and server operators from editing your objects.
Note: this does not protect objects against destruction (intentional), and may allow activation if appropriate. Also, the Carpenter's Safe is not affected by this.";
          ...
          "Enable Pane Alpha Rendering" = lib.mkOption {
            type = lib.types.bool;
            default = true;
            description = "This controls whether panes (used in doors, hatches, and other blocks) should render on alpha pass.
This is needed to allow translucent window glass, for instance.";
          ...
          "MultiBlock Size Limit" = lib.mkOption {
            type = lib.types.int;
            default = 500;
            description = "This controls how many blocks can be connected as a single entity.
Note: only applies to Garage Doors.";
          ...
          "Overlay Definitions" = lib.mkOption {
            ...
            description = "This maps items to overlays.
...
Overlay suffixes are :grass, :snow, :web, :vine, :hay, :mycelium";
          ...
          "Routable Fluids" = lib.mkOption {
            type = lib.types.bool;
            default = false;
            description = "When enabled, unobstructed stationary fluid adjacent to block will render in the block space.
Note: when enabled, you may experience noticeable chunk update lag spikes.";
          };
          Smoothness = lib.mkOption {
            type = lib.types.int;
            default = 4;
            description = "This controls the smoothness of the slope faces.
