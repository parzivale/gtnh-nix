      ...
      bedrock = lib.mkOption {
        ...
        type = lib.types.submodule {
          ...
          "Bedrock block ID" = lib.mkOption {
            ...
            description = "The block to use for the bottom of the Overworld.
[default: minecraft:bedrock]";
          };
          "Bedrock block meta value" = lib.mkOption {
            type = lib.types.int;
            default = 0;
            description = "The meta value of the bedrock block.
[range: 0 ~ 15, default: 0]";
          };
          "Number of flat bedrock layers" = lib.mkOption {
            type = lib.types.int;
            default = 0;
            description = "0 = Normal bedrock (rough pattern); 1-5 = Number of flat bedrock layers to generate
[range: 0 ~ 5, default: 0]";
          };
          };
        };
      ...
      biomes = lib.mkOption {
        ...
        type = lib.types.submodule {
          ...
          "Enable RTG Biome Decorations" = lib.mkOption {
            type = lib.types.bool;
            default = true;
            description = "If TRUE, uses the individual biome settings in the biome config files. If FALSE, disables all RTG decorations and uses vanilla decorations instead.
[default: true]";
          };
          "Enable RTG Biome Surfaces" = lib.mkOption {
            type = lib.types.bool;
            default = true;
            description = "If TRUE, uses the individual biome settings in the biome config files. If FALSE, disables all RTG surfaces and uses vanilla surfaces instead.
[default: true]";
          };
          "Patch Biome ID" = lib.mkOption {
            type = lib.types.int;
            default = 1;
            description = "If RTG tries to generate an unsupported biome or a biome that has an ID conflict, it will generate this biome instead.
      ...
      boulders = lib.mkOption {
        ...
        type = lib.types.submodule {
          ...
          "1/x chance that Cobblestone Boulders will generate if given the opportunity to do so during world gen" = lib.mkOption {
            type = lib.types.int;
            default = 2;
            description = "1 = Always generate if possible; 2 = 50% chance; 4 = 25% chance
[range: 1 ~ 100, default: 1]";
          ...
          "UBC Boulders" = lib.mkOption {
            type = lib.types.bool;
            default = true;
            description = "Set this to TRUE to allow UBC to override cobblestone boulders.
      ...
      caves = lib.mkOption {
        ...
        type = lib.types.submodule {
          ...
          "Cave Density" = lib.mkOption {
            type = lib.types.int;
            default = 10;
            description = "This setting controls the size of caves.
...
[range: 1 ~ 40, default: 8]";
          ...
          "Cave Frequency" = lib.mkOption {
            type = lib.types.int;
            default = 16;
            description = "This setting controls the number of caves that generate.
...
[range: 1 ~ 40, default: 16]";
          ...
          "Enable Cave Modifications" = lib.mkOption {
            type = lib.types.bool;
            default = true;
            description = "Must be set to TRUE for the other cave settings to have any effect.
      ...
      debugging = lib.mkOption {
        ...
        type = lib.types.submodule {
          ...
          "Crash on Structure Exceptions" = lib.mkOption {
            type = lib.types.bool;
            default = false;
            description = "Instead of crashing when it experiences 'java.util.ConcurrentModificationException' (or any other exception)
...
[default: false]";
          ...
          "Enable Debugging" = lib.mkOption {
            type = lib.types.bool;
            default = false;
            description = "WARNING: This should only be enabled if you know what you're doing.
[default: false]";
          };
          };
        };
      ...
      dunes = lib.mkOption {
        ...
        type = lib.types.submodule {
          ...
          "Height of Dunes" = lib.mkOption {
            type = lib.types.int;
            default = 5;
            description = "This setting controls the height of both sand dunes and snow dunes.
      ...
      dungeons = lib.mkOption {
        ...
        type = lib.types.submodule {
          ...
          "Dungeon Frequency" = lib.mkOption {
            type = lib.types.int;
            default = 12;
            description = "This setting controls the number of dungeons that generate.
      ...
      "flowing liquids" = lib.mkOption {
        ...
        type = lib.types.submodule {
          ...
          "Flowing Lava Chance" = lib.mkOption {
            type = lib.types.int;
            default = 200;
            description = "1/x chance that a lava stream will generate on the side of a hill or mountain.
...
[range: 0 ~ 2147483647, default: 200]";
          ...
          "Flowing Water Chance" = lib.mkOption {
            type = lib.types.int;
            default = 200;
            description = "1/x chance that a water stream will generate on the side of a hill or mountain.
0 = Never generate; 1 = Always generate if possible; 2 = 50% chance; 4 = 25% chance
[range: 0 ~ 2147483647, default: 200]";
          };
          };
      ...
      plateaus = lib.mkOption {
        ...
        type = lib.types.submodule {
          ...
          "Mesa Bryce Plateau Block Metas" = lib.mkOption {
            ...
            description = "Comma-separated list of meta values for the plateau gradient blocks used in the Mesa Bryce biome.
...
[default: -1,-1,0,1,0,0,0,14,0,8,0,1,8,0,-1,0,14,0,0,14,0,0,8]";
          ...
          "Mesa Plateau Block Metas" = lib.mkOption {
            ...
            description = "Comma-separated list of meta values for the plateau gradient blocks used in the Mesa biome variants (doesn't include Mesa Bryce).
-1 = Plateau block; 0-15 = Plateau gradient block
0 = White; 1 = Orange; 2 = Magenta; 3 = Light Blue; 4 = Yellow; 5 = Lime; 6 = Pink; 7 = Gray
8 = Light Gray; 9 = Cyan; 10 = Purple; 11 = Blue; 12 = Brown; 13 = Green; 14 = Red; 15 = Black
[default: -1,-1,-1,1,1,1,0,-1,-1,6,1,1,8,0,-1,-1,14,-1,-1,6,1,1,4]";
          ...
          "Plateau Block ID" = lib.mkOption {
            ...
            description = "An extra block to use for Mesa & Savanna plateau gradients. Defaults to hardened clay.
...
[default: minecraft:hardened_clay]";
          ...
          "Plateau Block Meta Value" = lib.mkOption {
            type = lib.types.int;
            default = 0;
            description = "The meta value of the plateau block.
[range: 0 ~ 15, default: 0]";
          };
          "Plateau Gradient Block ID" = lib.mkOption {
            type = lib.types.str;
            default = "minecraft:stained_hardened_clay";
            description = "The block to use for Mesa & Savanna plateau gradients. Defaults to stained hardened clay.
...
[default: minecraft:stained_hardened_clay]";
          ...
          "Savanna Plateau Block Metas" = lib.mkOption {
            ...
            description = "Comma-separated list of meta values for the plateau gradient blocks used in the Savanna biome variants.
-1 = Plateau block; 0-15 = Plateau gradient block
0 = White; 1 = Orange; 2 = Magenta; 3 = Light Blue; 4 = Yellow; 5 = Lime; 6 = Pink; 7 = Gray
8 = Light Gray; 9 = Cyan; 10 = Purple; 11 = Blue; 12 = Brown; 13 = Green; 14 = Red; 15 = Black
[default: 0,0,0,0,8,8,12,12,8,0,8,12,12,8,12,8,0,0,8,12,12]";
          ...
          "Use stone for most Savanna biome variants" = lib.mkOption {
            type = lib.types.bool;
            default = true;
            description = "If set to TRUE, Savanna biome variants will mostly use stone/cobblestone instead of gradient blocks for cliffs and plateaus.
      ...
      ravines = lib.mkOption {
        ...
        type = lib.types.submodule {
          ...
          "Enable Ravine Modifications" = lib.mkOption {
            type = lib.types.bool;
            default = true;
            description = "Must be set to TRUE for the other ravine settings to have any effect.
...
[default: true]";
          ...
          "Ravine Frequency" = lib.mkOption {
            type = lib.types.int;
            default = 75;
            description = "This setting controls the number of ravines that generate.
      ...
      rivers = lib.mkOption {
        ...
        type = lib.types.submodule {
          ...
          "Enable Lush River Bank Decorations in Hot Biomes" = lib.mkOption {
            type = lib.types.bool;
            default = true;
            description = "Set this to FALSE to prevent RTG from generating lush river bank decorations in hot biomes, like Desert and Mesa.
...
[default: true]";
          ...
          "Enable Lush River Bank Surfaces in Hot Biomes" = lib.mkOption {
            type = lib.types.bool;
            default = true;
            description = "Set this to FALSE to prevent RTG from generating lush river bank surfaces in hot biomes, like Desert and Mesa.
      ...
      "rivers and scenic lakes" = lib.mkOption {
        ...
        type = lib.types.submodule {
          ...
          "Amplitude of Large-Scale River Cut Off" = lib.mkOption {
            type = lib.types.str;
            default = "0.5";
            description = "Higher numbers make the large-scale cut-off noise have a greater effect. Defaults to 0.5
[range: 0.0 ~ 2.0, default: 0.5]";
          };
          "Biome for frozen scenic lakes" = lib.mkOption {
            type = lib.types.int;
            default = 11;
            description = "Biome ID for scenic lakes when frozen (default 11 = Frozen River)
[range: 0 ~ 254, default: 11]";
          };
          "Biome for scenic lakes" = lib.mkOption {
            type = lib.types.int;
            default = 7;
            description = "Biome ID for scenic lakes when not frozen (default 7 = River)
[range: 0 ~ 254, default: 7]";
          };
          "Lake Frequency Multiplier" = lib.mkOption {
            type = lib.types.str;
            default = "1.5";
            description = "Defaults to 1 (standard frequency)
[range: 0.0 ~ 10.0, default: 1.0]";
          };
          "Lake Shore Irregularity" = lib.mkOption {
            type = lib.types.str;
            default = "1.5";
            description = "Makes scenic lake shores bend and curve more. Defaults to 1
[range: 0.0 ~ 2.0, default: 1.0]";
          };
          "Lake Size Multiplier" = lib.mkOption {
            type = lib.types.str;
            default = "1.0";
            description = "Defaults to 1 (standard size)
[range: 0.0 ~ 10.0, default: 1.0]";
          };
          "Multiplier to River Bending" = lib.mkOption {
            type = lib.types.str;
            default = "2.0";
            description = "Higher numbers make rivers bend more. Defaults to 1
[range: 0.0 ~ 2.0, default: 1.0]";
          };
          "River Frequency Multiplier" = lib.mkOption {
            type = lib.types.str;
            default = "1.5";
            description = "Multiplier to river frequencies. Defaults to 1
[range: 0.0 ~ 10.0, default: 1.0]";
          };
          "River Width Multiplier" = lib.mkOption {
            type = lib.types.str;
            default = "1.5";
            description = "Defaults to 1 (standard width)
[range: 0.0 ~ 10.0, default: 1.0]";
          };
          "Scale of Large-Scale River Cut Off" = lib.mkOption {
            type = lib.types.str;
            default = "350.0";
            description = "Higher numbers make grassy areas near rivers bigger, but also more rare. Defaults to 350
...
[default: true]";
          ...
          "RTG Tree from Vanilla Sapling Chance" = lib.mkOption {
            type = lib.types.int;
            default = 2;
            description = "1/x chance that a vanilla sapling will grow one of RTG's custom trees.
      ...
      "scattered features" = lib.mkOption {
        ...
        type = lib.types.submodule {
          ...
          "Enable Scattered Feature Modifications" = lib.mkOption {
            type = lib.types.bool;
            default = true;
            description = "Must be set to TRUE for the other scattered feature settings to have any effect.
...
[default: true]";
          ...
          "Maximum distance between scattered features" = lib.mkOption {
            type = lib.types.int;
            default = 48;
            description = "Scattered features = desert temples, jungle temples, and witch huts; 32 = Vanilla
[range: 1 ~ 2147483647, default: 48]";
          };
          "Minimum distance between scattered features" = lib.mkOption {
            type = lib.types.int;
            default = 12;
            description = "Scattered features = desert temples, jungle temples, and witch huts; 8 = Vanilla
      ...
      snow = lib.mkOption {
        ...
        type = lib.types.submodule {
          ...
          "Enable Snow Layers" = lib.mkOption {
            type = lib.types.bool;
            default = true;
            description = "This applies to newly-generated chunks only. Snow layers will still appear in cold/snowy biomes after it snows.
[default: true]";
          };
          };
        };
      ...
      "terrain shadowing" = lib.mkOption {
        ...
        type = lib.types.submodule {
          ...
          "Desert shadow block ID" = lib.mkOption {
            type = lib.types.str;
            default = "minecraft:stained_hardened_clay";
            description = "The block to use for desert terrain shadowing, typically seen on the cliffs of desert mountains. Defaults to stained hardened clay.
[default: minecraft:stained_hardened_clay]";
          };
          "Desert shadow block meta value" = lib.mkOption {
            type = lib.types.int;
            default = 0;
            description = "The meta value of the shadow block for desert cliffs. Defaults to 0 (white).
[range: 0 ~ 15, default: 0]";
          };
          "Stone shadow block ID" = lib.mkOption {
            type = lib.types.str;
            default = "minecraft:stained_hardened_clay";
            description = "The block to use for stone terrain shadowing, typically seen on the cliffs of stone mountains. Defaults to stained hardened clay.
[default: minecraft:stained_hardened_clay]";
          };
          "Stone shadow block meta value" = lib.mkOption {
            type = lib.types.int;
            default = 9;
            description = "The meta value of the shadow block for stone cliffs. Defaults to 9 (cyan).
[range: 0 ~ 15, default: 9]";
          };
          "UBC Mode (Desert)" = lib.mkOption {
            type = lib.types.bool;
            default = true;
            description = "Set this to TRUE to allow UBC to override desert shadowing.
This setting doesn't have any effect if UBC is not installed.
[default: true]";
          };
          "UBC Mode (Stone)" = lib.mkOption {
            type = lib.types.bool;
            default = true;
            description = "Set this to TRUE to allow UBC to override stone shadowing.
This setting doesn't have any effect if UBC is not installed.
[default: true]";
          };
          };
      ...
      trees = lib.mkOption {
        ...
        type = lib.types.submodule {
          ...
          "Allow Shrubs to Generate Below Surface" = lib.mkOption {
            type = lib.types.bool;
            default = true;
            description = "Set this to FALSE to prevent shrub trunks from generating below the surface.
[default: true]";
          };
          "Allow Trees to Generate on Sand" = lib.mkOption {
            type = lib.types.bool;
            default = false;
            description = "Set this to FALSE to prevent trees from generating on sand.
...
[default: false]";
          ...
          "Allow bark-covered logs" = lib.mkOption {
            type = lib.types.bool;
            default = true;
            description = "Set this to FALSE to prevent the trunks of RTG trees from using the 'all-bark' texture model.
      ...
      villages = lib.mkOption {
        ...
        type = lib.types.submodule {
          ...
          "Enable village modifications" = lib.mkOption {
            type = lib.types.bool;
            default = true;
            description = "Set this to FALSE to resolve issues with mods that also modify villages.
...
[default: true]";
          ...
          "Maximum distance between villages" = lib.mkOption {
            type = lib.types.int;
            default = 48;
            description = "Lower values = villages closer together; 32 = Vanilla
[range: 1 ~ 2147483647, default: 48]";
          };
          "Minimum distance between villages" = lib.mkOption {
            type = lib.types.int;
            default = 20;
            description = "Higher values = villages further apart; 8 = Vanilla
[range: 1 ~ 2147483647, default: 12]";
          };
          "Size of villages" = lib.mkOption {
            type = lib.types.int;
            default = 2;
            description = "Higher values = bigger villages; 0 = Vanilla
      ...
      volcanoes = lib.mkOption {
        ...
        type = lib.types.submodule {
          ...
          "Enable volcano eruptions" = lib.mkOption {
            type = lib.types.bool;
            default = true;
            description = "Set this to FALSE to prevent lava from flowing down the sides of volcanoes.
[default: true]";
          };
          "Enable volcanoes" = lib.mkOption {
            type = lib.types.bool;
            default = true;
            description = "Set this to FALSE to prevent volcanoes from generating.
[default: true]";
          };
          "Volcano Chance" = lib.mkOption {
            type = lib.types.int;
            default = 30;
            description = "1/x chance that a volcano will generate in a biome that has volcanoes enabled.
1 = Always generate if possible; 2 = 50% chance; 4 = 25% chance
[range: 1 ~ 2147483647, default: 36]";
          ...
          "Volcano block ID" = lib.mkOption {
            ...
            description = "The main block to use for the surface of the volcano.
[default: minecraft:obsidian]";
          };
          "Volcano block meta value" = lib.mkOption {
            type = lib.types.int;
            default = 0;
            description = "The meta value of the volcano block.
[range: 0 ~ 15, default: 0]";
          };
          "Volcano mix 1 block ID" = lib.mkOption {
            type = lib.types.str;
            default = "BiomesOPlenty:ashStone";
            description = "The block ID of the 1st volcano mix block.
[default: BiomesOPlenty:ashStone]";
          };
          "Volcano mix 1 block meta value" = lib.mkOption {
            type = lib.types.int;
            default = 0;
            description = "The meta value of the 1st volcano mix block.
[range: 0 ~ 15, default: 0]";
          };
          "Volcano mix 2 block ID" = lib.mkOption {
            type = lib.types.str;
            default = "BiomesOPlenty:ash";
            description = "The block ID of the 2nd volcano mix block.
[default: BiomesOPlenty:ash]";
          };
          "Volcano mix 2 block meta value" = lib.mkOption {
            type = lib.types.int;
            default = 0;
            description = "The meta value of the 2nd volcano mix block.
[range: 0 ~ 15, default: 0]";
          };
          "Volcano mix 3 block ID" = lib.mkOption {
            type = lib.types.str;
            default = "minecraft:coal_block";
            description = "The block ID of the 3rd volcano mix block.
[default: minecraft:coal_block]";
          };
          "Volcano mix 3 block meta value" = lib.mkOption {
            type = lib.types.int;
            default = 0;
            description = "The meta value of the 3rd volcano mix block.
[range: 0 ~ 15, default: 0]";
          };
          };
        };
