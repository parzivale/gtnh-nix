          ...
          type = lib.types.submodule {
            options = {
              ...
              LeaveDecayFuzz = lib.mkOption {
                type = lib.types.int;
                default = 5;
                description = "A random number from 0-thisconfigoption will be added to the decay speed for every leaf. Setting this to 0 will decay leaves rather linearly while higher numbers will let the whole thing look more natural";
              };
          ...
          type = lib.types.submodule {
            options = {
              ...
              "Hardcore Darkness" = lib.mkOption {
                type = lib.types.bool;
                default = false;
                description = "The minimum light will be removed so if there's no light source it's actually going to be completely black";
              };
