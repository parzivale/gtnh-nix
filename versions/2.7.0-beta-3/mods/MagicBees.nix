      ...
      general = lib.mkOption {
        ...
        type = lib.types.submodule {
          ...
          "backpack.forestry.addThaumcraftItems" = lib.mkOption {
            type = lib.types.bool;
            default = true;
            description = "Set to true if you want MagicBees to add several Thaumcraft blocks & items to Forestry backpacks.
Set to false to disable.";
          ...
          "backpack.thaumaturge.additionalItems" = lib.mkOption {
            ...
            description = "Add additional items to the Thaumaturge's Backpack.
Format is the same as Forestry's: id:meta;id;id:meta (etc)";
          };
          capsuleStackSize = lib.mkOption {
            type = lib.types.int;
            default = 64;
            description = "Allows you to edit the stack size of the capsules in MagicBees if using GregTech,
