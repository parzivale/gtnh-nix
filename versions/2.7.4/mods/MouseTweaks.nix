          ...
          type = lib.types.submodule {
            options = {
              ScrollItemScaling = lib.mkOption {
                type = lib.types.int;
                default = 0;
                description = "Scroll Scaling 0 - Multiple Wheel Clicks Move Multiple Items 1 - Always Move One Item (macOS Compatibility) [range: 0 ~ 1, default: 0]";
              };
              WheelScrollDirection = lib.mkOption {
                type = lib.types.int;
                default = 0;
                description = "Wheel Scroll Direction 0 - Down to Push, Up to Pull 1 - Up to Push, Down to Pull 2 - Inventory Position Aware 3 - Inventory Position Aware, Inverted [range: 0 ~ 3, default: 0]";
              };
              ...
              WheelSearchOrder = lib.mkOption {
                type = lib.types.int;
                default = 1;
                description = "Wheel Inventory Slot Search Order 0 - First to Last 1 - Last To First [range: 0 ~ 1, default: 1]";
              };
