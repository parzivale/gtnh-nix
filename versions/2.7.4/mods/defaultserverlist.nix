        ...
        servers = lib.mkOption {
          ...
          type = lib.types.submodule {
            options = {
              ...
              "EpochCraft GTNH [EU]" = lib.mkOption {
                type = lib.types.str;
                default = "alpha.epochcraft.space";
              };
              ...
              "MyFTB GTNH German Server" = lib.mkOption {
                type = lib.types.str;
                default = "gtnewhorizons.myftb.de";
              };
              "StoneHuts GTNH EU whitelisted" = lib.mkOption {
                type = lib.types.str;
                default = "gtnh.stonehuts.net";
              };
              "Zvezdolet GTNH Server 1" = lib.mkOption {
                type = lib.types.str;
                default = "gtnh.114-7.com";
              };
              "Zvezdolet GTNH Server 2" = lib.mkOption {
                type = lib.types.str;
                default = "gtnh2.114-7.com";
              };
              "Zvezdolet GTNH Server 3" = lib.mkOption {
                type = lib.types.str;
