  ...
  OpenComputers_cfg = lib.mkOption {
    ...
    type = lib.types.submodule {
      ...
      opencomputers = lib.mkOption {
        default = {};
        description = "OpenComputers configuration. This file uses typesafe config's HOCON syntax.
          ...
          chunkloader = lib.mkOption {
            ...
            type = lib.types.submodule {
              ...
              dimBlacklist = lib.mkOption {
                ...
                default = [ ];
                description = "This is a list of forbidden dimensions in the form of numeric IDs.
...
this list.";
              ...
              dimWhitelist = lib.mkOption {
                type = lib.types.listOf lib.types.str;
                default = [ ];
                description = "This is a list of allowed dimensions in the form of numeric IDs.
          ...
          client = lib.mkOption {
            ...
            type = lib.types.submodule {
              ...
              beepSampleRate = lib.mkOption {
                type = lib.types.int;
                default = 44100;
                description = "The sample rate used for generating beeps of computers' internal
...
leads to artifacting on certain frequencies).";
              ...
              beepVolume = lib.mkOption {
                type = lib.types.int;
                default = 32;
                description = "The base volume of beeps generated by computers. This may be in a
...
generated), and 127 means maximum amplitude / volume.";
              ...
              enableNanomachinePfx = lib.mkOption {
                type = lib.types.bool;
                default = true;
                description = "Whether to emit particle effects around players via nanomachines. This
...
particle effect behaviors.";
              ...
              fontCharScale = lib.mkOption {
                ...
                default = 1.01;
                description = "This is the scaling of the individual chars rendered on screens. This
...
a *lot* of unicode).";
              ...
              hologramFadeStartDistance = lib.mkOption {
                type = lib.types.int;
                default = 48;
                description = "The distance at which to start fading out the hologram (as with
...
It does not affect performance. Holograms are transparent anyway.";
              ...
              hologramFlickerFrequency = lib.mkOption {
                type = lib.types.float;
                default = 0.025;
                description = "This controls how often holograms 'flicker'. This is the chance that it
...
may want to lower this a bit, to avoid it flickering too much.";
              ...
              hologramRenderDistance = lib.mkOption {
                type = lib.types.int;
                default = 64;
                description = "The maximum render distance of a hologram projected by a highest tier
...
down with the actual scale of the hologram.";
              ...
              maxScreenTextRenderDistance = lib.mkOption {
                type = lib.types.int;
                default = 20;
                description = "The maximum distance at which to render text on screens. Rendering text
...
only has an impact on render performance on clients.";
              ...
              monochromeColor = lib.mkOption {
                type = lib.types.str;
                default = "0xFFFFFF";
                description = "The color of monochrome text (i.e. displayed when in 1-bit color depth,
...
Defaults to white, feel free to make it some other color, tho!";
              ...
              nanomachineHudPos = lib.mkOption {
                ...
                default = [ (-1) (-1) ];
                description = "Position of the power indicator for nanomachines, by default left to the
...
absolute positions.";
              ...
              screenTextFadeStartDistance = lib.mkOption {
                type = lib.types.int;
                default = 15;
                description = "The distance at which to start fading out the text on screens. This is
...
displaying it.";
              ...
              soundVolume = lib.mkOption {
                type = lib.types.int;
                default = 1;
                description = "The volume multiplier applied to sounds from this mod like the computer
running noise. Disable sounds by setting this to zero.";
              };
              textAntiAlias = lib.mkOption {
                type = lib.types.bool;
                default = true;
                description = "If you prefer the text on the screens to be aliased (you know, *not*
anti-aliased / smoothed) turn this option off.";
              };
              textLinearFiltering = lib.mkOption {
                type = lib.types.bool;
                default = false;
                description = "Whether to apply linear filtering for text displayed on screens when the
          ...
          computer = lib.mkOption {
            ...
            type = lib.types.submodule {
              ...
              callBudgets = lib.mkOption {
                ...
                default = [ 0.5 1.0 1.5 ];
                description = "The provided call budgets by the three tiers of CPU. Higher budgets
...
contain exactly three entries, or it will be ignored.";
              ...
              canComputersBeOwned = lib.mkOption {
                type = lib.types.bool;
                default = true;
                description = "This determines whether computers can only be used by players that are
...
See also: `maxUsers` and `maxUsernameLength`.";
              ...
              cpuComponentCount = lib.mkOption {
                ...
                description = "The number of components the different CPU tiers support. This list
must contain exactly four entries, or it will be ignored.";
              ...
              eraseTmpOnReboot = lib.mkOption {
                type = lib.types.bool;
                default = false;
                description = "Whether to delete all contents in the /tmp file system when performing
...
it crashed. This setting is purely for software-triggered reboots.";
              ...
              executionDelay = lib.mkOption {
                type = lib.types.int;
                default = 12;
                description = "The time in milliseconds that scheduled computers are forced to wait
              ...
              lua = lib.mkOption {
                ...
                type = lib.types.submodule {
                  ...
                  allowBytecode = lib.mkOption {
                    type = lib.types.bool;
                    default = false;
                    description = "Whether to allow loading precompiled bytecode via Lua's `load`
...
know what you're doing.";
                  ...
                  allowGC = lib.mkOption {
                    type = lib.types.bool;
                    default = false;
                    description = "Whether to allow user defined __gc callbacks, i.e. __gc callbacks
...
recommended.";
                  ...
                  defaultLua53 = lib.mkOption {
                    type = lib.types.bool;
                    default = false;
                    description = "Whether to make the Lua 5.3 architecture the default architecture.
If enabled, a crafted CPU will first be the Lua 5.3 architecture.";
                  };
                  enableLua53 = lib.mkOption {
                    type = lib.types.bool;
                    default = true;
                    description = "Whether to make the Lua 5.3 architecture available. If enabled, you
can reconfigure any CPU to use the Lua 5.3 architecture.";
                  };
                  enableLua54 = lib.mkOption {
                    type = lib.types.bool;
                    default = false;
                    description = "Whether to make the Lua 5.4 architecture available. If enabled, you
can reconfigure any CPU to use the Lua 5.4 architecture.";
                  };
                  maxTotalRam = lib.mkOption {
                    type = lib.types.int;
                    default = 67108864;
                    description = "The total maximum amount of memory a Lua machine may use for user
...
IN PARTICULAR, DO NOT REPORT ISSUES AFTER MESSING WITH THIS!";
                  ...
                  ramScaleFor64Bit = lib.mkOption {
                    type = lib.types.float;
                    default = 1.8;
                    description = "This setting allows you to fine-tune how RAM sizes are scaled internally
...
are really 45KB free, `computer.freeMemory` will return 32KB.";
                  ...
                  ramSizes = lib.mkOption {
                    ...
                    description = "The sizes of the six levels of RAM, in kilobytes. This list must
...
items (level 1, 2 = tier 1, level 3, 4 = tier 2, level 5, 6 = tier 3).";
              ...
              maxSignalQueueSize = lib.mkOption {
                type = lib.types.int;
                default = 256;
                description = "The maximum depth a machine will queue signals before dropping them
...
text of this many lines. The default (and minimum) is 256";
              ...
              maxUsernameLength = lib.mkOption {
                type = lib.types.int;
                default = 32;
                description = "Sanity check for username length for users registered with computers. We
...
See also: `canComputersBeOwned`.";
              ...
              maxUsers = lib.mkOption {
                type = lib.types.int;
                default = 16;
                description = "The maximum number of users that can be registered with a single
...
`canComputersBeOwned`.";
              ...
              startupDelay = lib.mkOption {
                type = lib.types.float;
                default = 0.25;
                description = "The time in seconds to wait after a computer has been restored before it
...
happen.";
              ...
              threads = lib.mkOption {
                type = lib.types.int;
                default = 4;
                description = "The overall number of threads to use to drive computers. Whenever a
...
system's load may become.";
              ...
              timeout = lib.mkOption {
                type = lib.types.int;
                default = 5;
                description = "The time in seconds a program may run without yielding before it is
...
already running - they'll have to be rebooted for this to take effect.";
          ...
          debug = lib.mkOption {
            default = {};
            description = "Settings that are intended for debugging issues, not for normal use.
You usually don't want to touch these unless asked to do so by a developer.";
            type = lib.types.submodule {
              ...
              alwaysTryNative = lib.mkOption {
                type = lib.types.bool;
                default = false;
                description = "On some platforms the native library can crash the game, so there are
...
crashes as a result of setting this to `true` DO NOT REPORT IT.";
              ...
              debugCardAccess = lib.mkOption {
                type = lib.types.str;
                default = "allow";
                description = "Enable debug card functionality. This may also be of use for custom
...
make all functions it provides error out.";
              ...
              disableLocaleChanging = lib.mkOption {
                type = lib.types.bool;
                default = false;
                description = "Prevent OC calling Lua's os.setlocale method to ensure number
...
the native C locale).";
              ...
              disableMemoryLimit = lib.mkOption {
                type = lib.types.bool;
                default = false;
                description = "Disable memory limit enforcement. This means Lua states can
...
using the native library.";
              ...
              disablePersistence = lib.mkOption {
                type = lib.types.bool;
                default = false;
                description = "Disable computer state persistence. This means that computers will
...
saved). Only relevant when using the native library.";
              ...
              disableUserdata = lib.mkOption {
                type = lib.types.bool;
                default = false;
                description = "Disable user data support. This means any otherwise supported
...
just make all functions it provides error out.";
              ...
              forceCaseInsensitiveFS = lib.mkOption {
                type = lib.types.bool;
                default = false;
                description = "Force the buffered file system to be case insensitive. This makes it
...
This only takes effect when bufferChanges is set to true.";
              ...
              forceLuaJ = lib.mkOption {
                type = lib.types.bool;
                default = false;
                description = "Forces the use of the LuaJ fallback instead of the native libraries.
...
issues with the native library.";
              ...
              forceNativeLibPathFirst = lib.mkOption {
                type = lib.types.str;
                default = "";
                description = "Force the native library loader to check the specified directory for natives first,
...
directory of the running Minecraft instance.";
              ...
              forceNativeLibPlatform = lib.mkOption {
                type = lib.types.str;
                default = "";
                description = "Force the platform name for the native libraries, instead of relying
...
or \"windows-aarch64\" for Windows on the aarch64 (64-bit arm) architecture.";
              ...
              forceNativeLibWithName = lib.mkOption {
                type = lib.types.str;
                default = "";
                description = "Force loading one specific library, to avoid trying to load any
...
so for debugging purposes ;-)";
              ...
              insertIdsInConverters = lib.mkOption {
                type = lib.types.bool;
                default = false;
                description = "Pass along IDs of items and fluids when converting them to a table
representation for Lua.";
              };
              logCallbackErrors = lib.mkOption {
                type = lib.types.bool;
                default = false;
                description = "This setting is meant for debugging errors that occur in Lua callbacks.
...
exceptions such as IllegalArgumentExceptions and the like.";
              ...
              logFullNativeLibLoadErrors = lib.mkOption {
                type = lib.types.bool;
                default = false;
                description = "Logs the full error when a native library fails to load. This is
...
to work.";
              ...
              logHexFontErrors = lib.mkOption {
                type = lib.types.bool;
                default = false;
                description = "Logs information about malformed glyphs (i.e. glyphs that deviate in
width from what wcwidth says).";
              };
              logOpenGLErrors = lib.mkOption {
                type = lib.types.bool;
                default = false;
                description = "Used to suppress log spam for OpenGL errors on derpy drivers. I'm
...
multiple servers or server and client on the same machine.";
              ...
              periodicallyForceLightUpdate = lib.mkOption {
                type = lib.types.bool;
                default = false;
                description = "Due to a bug in Minecraft's lighting code there's an issue where
...
by default because it is unnecessary in *most* cases.";
              ...
              registerLuaJArchitecture = lib.mkOption {
                type = lib.types.bool;
                default = false;
                description = "Whether to always register the LuaJ architecture - even if the native
...
the two like any other registered architecture.";
              ...
              verbosePersistenceErrors = lib.mkOption {
                type = lib.types.bool;
                default = false;
                description = "This is meant for debugging errors. Enabling this has a high impact
          ...
          filesystem = lib.mkOption {
            ...
            type = lib.types.submodule {
              ...
              bufferChanges = lib.mkOption {
                type = lib.types.bool;
                default = false;
                description = "Whether persistent file systems such as disk drivers should be
...
returned via the API will always be the real file size, however.";
              ...
              hddPlatterCounts = lib.mkOption {
                type = lib.types.listOf lib.types.int;
                default = [ 2 4 6 ];
                description = "Number of physical platters to pretend a disk has in unmanaged mode. This
...
a common head position for access).";
              ...
              hddSizes = lib.mkOption {
                ...
                description = "The sizes of the three tiers of hard drives, in kilobytes. This list
must contain exactly three entries, or it will be ignored.";
              };
              maxHandles = lib.mkOption {
                type = lib.types.int;
                default = 16;
                description = "The maximum number of file handles any single computer may have open at
...
on the host operating system.";
              ...
              maxReadBuffer = lib.mkOption {
                type = lib.types.int;
                default = 2048;
                description = "The maximum block size that can be read in one 'read' call on a file
...
performance of file systems.";
              ...
              sectorSeekThreshold = lib.mkOption {
                type = lib.types.int;
                default = 128;
                description = "When skipping more than this number of sectors in unmanaged mode, the
...
really small, which is hard to conceptualize and configure.";
              ...
              tmpSize = lib.mkOption {
                type = lib.types.int;
                default = 64;
                description = "The size of the /tmp filesystem that each computer gets for free. If
          ...
          gpu = lib.mkOption {
            ...
            type = lib.types.submodule {
              ...
              bitbltCost = lib.mkOption {
                type = lib.types.float;
                default = 0.5;
                description = "This setting assigns the budget call cost to invoke bitblt to write vram
...
default is .5, which gives: .5, 1, 4";
              ...
              vramSizes = lib.mkOption {
                type = lib.types.listOf lib.types.int;
                default = [ 1 2 3 ];
                description = "Video ram can be allocated on a gpu. The amount of vram you can allocate
          ...
          hologram = lib.mkOption {
            ...
            type = lib.types.submodule {
              ...
              emitLight = lib.mkOption {
                type = lib.types.bool;
                default = true;
                description = "Whether the hologram block should provide light. It'll also emit light
when off, because having state-based light in MC is... painful.";
              };
              maxScale = lib.mkOption {
                type = lib.types.listOf lib.types.int;
                default = [ 3 4 ];
                description = "This controls the maximum scales of holograms, by tier.
...
issues due to the high view distance! Increase at your own peril.";
              ...
              maxTranslation = lib.mkOption {
                type = lib.types.listOf lib.types.float;
                default = [ 0.25 0.5 ];
                description = "This controls the maximum translation of holograms, by tier.
...
hologram once by its own size.";
              ...
              setRawDelay = lib.mkOption {
                type = lib.types.float;
                default = 0.2;
                description = "The delay forced on computers between calls to `hologram.setRaw`, in
          ...
          integration = lib.mkOption {
            ...
            type = lib.types.submodule {
              ...
              fakePlayerName = lib.mkOption {
                ...
                description = "The name to use for the global fake player needed for some mod
interactions.";
              };
              fakePlayerUuid = lib.mkOption {
                type = lib.types.str;
                default = "7e506b5d-2ccb-4ac4-a249-5624925b0c67";
                description = "The UUID to use for the global fake player needed for some mod
interactions.";
              };
              modBlacklist = lib.mkOption {
                type = lib.types.listOf lib.types.str;
                default = [ ];
                description = "A list of mods (by mod id) for which support should NOT be enabled. Use
...
list by default.)";
              ...
              peripheralBlacklist = lib.mkOption {
                ...
                description = "A list of tile entities by class name that should NOT be accessible via
              ...
              vanilla = lib.mkOption {
                ...
                type = lib.types.submodule {
                  ...
                  allowItemStackNBTTags = lib.mkOption {
                    type = lib.types.bool;
                    default = true;
                    description = "Whether to allow the item stack converter to push NBT data in
...
The recommended method is to use the database component instead.";
                  ...
                  enableCommandBlockDriver = lib.mkOption {
                    type = lib.types.bool;
                    default = false;
                    description = "Whether to enable the command block driver. Enabling this allows
...
adapter blocks. The commands are run using OC's general fake player.";
                  ...
                  enableInventoryDriver = lib.mkOption {
                    type = lib.types.bool;
                    default = false;
                    description = "Whether to enable the inventory driver. This driver allows interacting
...
to enable this driver.";
                  ...
                  enableTankDriver = lib.mkOption {
                    type = lib.types.bool;
                    default = false;
                    description = "Whether to enable the tank driver. This driver is like the inventory
          ...
          internet = lib.mkOption {
            ...
            type = lib.types.submodule {
              ...
              blacklist = lib.mkOption {
                type = lib.types.listOf lib.types.str;
                default = [ ];
                description = "No longer used! See internet.filteringRules.
...
\"172.16.0.0/12\"";
              ...
              enableHttp = lib.mkOption {
                type = lib.types.bool;
                default = true;
                description = "Whether to allow HTTP requests via internet cards. When enabled,
the `request` method on internet card components becomes available.";
              ...
              enableTcp = lib.mkOption {
                type = lib.types.bool;
                default = true;
                description = "Whether to allow TCP connections via internet cards. When enabled,
the `connect` method on internet card components becomes available.";
              ...
              filteringRules = lib.mkOption {
                ...
                description = "This is a list of filtering rules. For any HTTP request or TCP socket
...
mod's context in an appropriate manner, e.g. using a system firewall.";
              ...
              maxTcpConnections = lib.mkOption {
                type = lib.types.int;
                default = 4;
                description = "The maximum concurrent TCP connections *each* internet card can have
open at a time.";
              };
              requestTimeout = lib.mkOption {
                type = lib.types.int;
                default = 0;
                description = "The time in seconds to wait for a response to a request before timing
...
request will never time out.";
              ...
              threads = lib.mkOption {
                type = lib.types.int;
                default = 4;
                description = "The number of threads used for processing host name lookups and HTTP
          ...
          misc = lib.mkOption {
            ...
            type = lib.types.submodule {
              ...
              allowItemStackInspection = lib.mkOption {
                type = lib.types.bool;
                default = true;
                description = "Allow robots to get a table representation of item stacks using the
...
upgrade and it's fluid getter method.";
              ...
              assemblerBlacklist = lib.mkOption {
                type = lib.types.listOf lib.types.str;
                default = [ ];
                description = "List of item descriptors of assembler template base items to blacklist,
...
Examples: 'OpenComputers:case3', 'minecraft:stonebrick@1'";
              ...
              dataCardHardLimit = lib.mkOption {
                type = lib.types.int;
                default = 1048576;
                description = "Hard limit for size of byte arrays passed to data card callbacks. If this
limit is exceeded, the call fails and does nothing.";
              };
              dataCardSoftLimit = lib.mkOption {
                type = lib.types.int;
                default = 8192;
                description = "Soft limit for size of byte arrays passed to data card callbacks. If this
limit is exceeded, a longer sleep is enforced (see dataCardTimeout).";
              };
              dataCardTimeout = lib.mkOption {
                type = lib.types.int;
                default = 1;
                description = "Time in seconds to pause a calling machine when the soft limit for a data
card callback is exceeded.";
              };
              disassembleAllTheThings = lib.mkOption {
                type = lib.types.bool;
                default = false;
                description = "By default the disassembler can only be used to disassemble items from
...
other mods, set this to true.";
              ...
              disassemblerBreakChance = lib.mkOption {
                type = lib.types.float;
                default = 0.05;
                description = "The probability that an item breaks when disassembled. This chance
...
this chance of breaking in the process.";
              ...
              disassemblerInputBlacklist = lib.mkOption {
                ...
                description = "Names of items / blocks that are blacklisted. Recipes containing these
as inputs will be ignored by the disassembler.";
              };
              diskActivitySoundDelay = lib.mkOption {
                type = lib.types.int;
                default = 500;
                description = "Delay between disk activity sounds, specified in milliseconds.
If set to -1, no disk activity update packets are sent.";
              };
              geolyzerNoise = lib.mkOption {
                type = lib.types.int;
                default = 2;
                description = "Controls how noisy results from the Geolyzer are. This is the maximum
...
trade-off.";
              ...
              geolyzerRange = lib.mkOption {
                type = lib.types.int;
                default = 32;
                description = "The range, in blocks, in which the Geolyzer can scan blocks. Note that
...
in a cube surrounding it with twice this value as its edge length.";
              ...
              giveManualToNewPlayers = lib.mkOption {
                type = lib.types.bool;
                default = false;
                description = "Whether to give a new player a free copy of the manual. This will only
...
is still too much for your taste, disable it here ;-)";
              ...
              initialNetworkPacketTTL = lib.mkOption {
                type = lib.types.int;
                default = 5;
                description = "The TTL (Time-To-Live) upon creation of a network packet. When a packet
...
impact on performances.";
              ...
              inputUsername = lib.mkOption {
                type = lib.types.bool;
                default = true;
                description = "Whether to pass along the name of the user that caused an input signals
...
Note: also applies to the motion sensor.";
              ...
              lootProbability = lib.mkOption {
                type = lib.types.int;
                default = 5;
                description = "The probability (or rather, weighted chance) that a program disk is
...
is decided in an extra roll of the dice.";
              ...
              maxClipboard = lib.mkOption {
                type = lib.types.int;
                default = 1024;
                description = "The maximum length of a string that may be pasted. This is used to limit
...
string from the clipboard (Shift+Ins on a screen with a keyboard).";
              ...
              maxNetworkClientEffectPacketDistance = lib.mkOption {
                type = lib.types.int;
                default = 64;
                description = "Maximum distance for visual effects sent from the client to the server.
These are non-essential - losing them should not cause glitches on the client side.";
              ...
              maxNetworkClientPacketDistance = lib.mkOption {
                type = lib.types.int;
                default = 0;
                description = "Maximum distance for updates sent from the client to the server, in blocks.
...
If set to 0, this option is ignored.";
              ...
              maxNetworkClientSoundPacketDistance = lib.mkOption {
                type = lib.types.int;
                default = 32;
                description = "Maximum distance for sound effects sent from the client to the server.
These are non-essential - losing them should not cause glitches on the client side.";
              };
              maxNetworkPacketParts = lib.mkOption {
                type = lib.types.int;
                default = 8;
                description = "The maximum number of \"data parts\" a network packet is allowed to have.
...
computers, to avoid them getting nuked by more powerful computers.";
              ...
              maxNetworkPacketSize = lib.mkOption {
                type = lib.types.int;
                default = 8192;
                description = "The maximum size of network packets to allow sending via network cards.
...
not apply to HTTP traffic.";
              ...
              maxOpenPorts = lib.mkOption {
                type = lib.types.listOf lib.types.int;
                default = [ 16 1 16 ];
                description = "The maximum number of ports a single network card can have opened at
any given time.
...
Network Card -> Tier 2 Wireless Network Card";
              ...
              maxScreenHeight = lib.mkOption {
                type = lib.types.int;
                default = 6;
                description = "The maximum height of multi-block screens, in blocks. This is limited to
...
efficient (i.e. when adding/removing a single screen).";
              ...
              maxScreenWidth = lib.mkOption {
                type = lib.types.int;
                default = 8;
                description = "The maximum width of multi-block screens, in blocks.
See also: `maxScreenHeight`.";
              };
              maxWirelessRange = lib.mkOption {
                type = lib.types.listOf lib.types.int;
                default = [ 16 400 ];
                description = "The maximum distance a wireless message can be sent. In other words,
...
These values are for the tier 1 and 2 wireless cards, in that order.";
              ...
              presentChance = lib.mkOption {
                type = lib.types.float;
                default = 0.05;
                description = "Probablility that at certain celebratory times crafting an OC item will
...
disable.";
              ...
              redstoneDelay = lib.mkOption {
                type = lib.types.float;
                default = 0.1;
                description = "Enforced delay when changing a redstone emitting component's output,
...
have very negative impact on server TPS, so beware.";
              ...
              serverRackSwitchTier = lib.mkOption {
                type = lib.types.int;
                default = 1;
                description = "The general upgrade tier of the switch built into server racks, i.e. how
...
Valid values are: 0 = none, 1 = tier 1, 2 = tier 2, 3 = tier 3.";
              ...
              threadPriority = lib.mkOption {
                type = lib.types.int;
                default = -1;
                description = "Override for the worker threads' thread priority. If set to a value
...
server load. AGAIN, USE WITH CARE!";
              ...
              tradingRange = lib.mkOption {
                type = lib.types.int;
                default = 8;
                description = "The maximum range between the drone/robot and a villager for a trade to
be performed by the trading upgrade";
              };
              transposerFluidTransferRate = lib.mkOption {
                type = lib.types.int;
                default = 2560;
                description = "Transposer fluid transfer rate in millibuckets per second
...
wait ((Amount in mbuckets)/transposerFluidTransferRate) seconds";
              ...
              updateCheck = lib.mkOption {
                type = lib.types.bool;
                default = false;
                description = "Whether to perform an update check and informing local players and OPs
...
joins a server / the first map in single player is opened).";
          ...
          nanomachines = lib.mkOption {
            default = {};
            description = "Nanomachine related values. Note that most of these are relative, as
...
increase their amplification value).";
            type = lib.types.submodule {
              ...
              commandDelay = lib.mkOption {
                type = lib.types.int;
                default = 1;
                description = "Time in seconds it takes for the nanomachines to process a command
and send a response.";
              };
              commandRange = lib.mkOption {
                type = lib.types.int;
                default = 2;
                description = "The distance in blocks that nanomachines can communicate within. If
...
the response will only be sent this far.";
              ...
              connectorQuota = lib.mkOption {
                type = lib.types.float;
                default = 0.2;
                description = "The relative number of connectors based on the number of available
behaviors (see triggerQuota).";
              ...
              hungryDamage = lib.mkOption {
                type = lib.types.int;
                default = 5;
                description = "How much damage the hungry behavior should deal to the player when the
nanomachine controller runs out of energy.";
              };
              hungryEnergyRestored = lib.mkOption {
                type = lib.types.int;
                default = 50;
                description = "How much energy the hungry behavior should restore when damaging the
player.";
              };
              ...
              maxInputs = lib.mkOption {
                type = lib.types.int;
                default = 2;
                description = "The maximum number of inputs for each node of the \"neural network\"
...
may only have up to this many inputs.";
              ...
              maxInputsActive = lib.mkOption {
                type = lib.types.int;
                default = 4;
                description = "Hard maximum number of active inputs. This is mainly to avoid people
...
to make use of here, since they will all be disabled by default.";
              ...
              safeInputsActive = lib.mkOption {
                type = lib.types.int;
                default = 2;
                description = "How many input nodes may be active at the same time before negative
effects are applied to the player.";
              };
              triggerQuota = lib.mkOption {
                type = lib.types.float;
                default = 0.4;
                description = "The relative amount of triggers available based on the number of
          ...
          power = lib.mkOption {
            ...
            type = lib.types.submodule {
              ...
              assemblerTickAmount = lib.mkOption {
                type = lib.types.int;
                default = 50;
                description = "The amount of energy the robot assembler can apply per tick. This
              ...
              buffer = lib.mkOption {
                ...
                type = lib.types.submodule {
                  ...
                  batteryUpgrades = lib.mkOption {
                    ...
                    description = "The amount of energy a capacitor can store when installed as an
upgrade into a robot.";
                  ...
                  capacitorAdjacencyBonus = lib.mkOption {
                    type = lib.types.int;
                    default = 800;
                    description = "The amount of bonus energy a capacitor can store for each other
...
(1.6 + 0.8 + 0.4)k + (0.8 + 1.6 + 0.8)k + (0.4 + 0.8 + 1.6)k";
                  ...
                  computer = lib.mkOption {
                    type = lib.types.int;
                    default = 500;
                    description = "The amount of energy a computer can store. This allows you to get a
computer up and running without also having to build a capacitor.";
                  };
                  converter = lib.mkOption {
                    type = lib.types.int;
                    default = 1000;
                    description = "The amount of energy a converter can store. This allows directly
...
capacitor on the side of the converter.";
                  ...
                  distributor = lib.mkOption {
                    type = lib.types.int;
                    default = 500;
                    description = "The amount of energy each face of a distributor can story. This
...
add capacitors between two distributors to increase this bandwidth.";
                  ...
                  mcu = lib.mkOption {
                    type = lib.types.int;
                    default = 1000;
                    description = "The amount of energy a microcontroller can store in its internal
buffer.";
                  };
                  nanomachines = lib.mkOption {
                    type = lib.types.int;
                    default = 100000;
                    description = "Amount of energy stored by nanomachines. Yeah, I also don't know
where all that energy is stored. It's quite fascinating.";
              ...
              carpetedCapacitors = lib.mkOption {
                default = {};
                description = "Carpeted Capacitor settings
...
capacitor per second with 2 animals of a type.";
                type = lib.types.submodule {
                  ...
                  damageChance = lib.mkOption {
                    type = lib.types.float;
                    default = 0.001;
                    description = "Chance one animal (per capacitor) will take some damage per minute
Damage chance is only dealt when power is generated";
              ...
              chargerChargeRate = lib.mkOption {
                type = lib.types.int;
                default = 100;
                description = "The amount of energy a Charger transfers to each adjacent robot per tick
...
charge robots at roughly half speed.";
              ...
              chargerChargeRateTablet = lib.mkOption {
                type = lib.types.int;
                default = 10;
                description = "The amount of energy a Charger transfers into a tablet, if present, per
              ...
              cost = lib.mkOption {
                ...
                type = lib.types.submodule {
                  ...
                  chunkloaderCost = lib.mkOption {
                    type = lib.types.float;
                    default = 0.06;
                    description = "The amount of energy the chunkloader upgrade draws per tick while
it is enabled, i.e. actually loading a chunk.";
                  ...
                  dataCardAsymmetric = lib.mkOption {
                    type = lib.types.int;
                    default = 10;
                    description = "Cost for asymmetric operations on the data card, such as ECDH and ECDSA
...
because data is hashed with SHA256 before signing/verifying";
                  ...
                  disassemblerPerItem = lib.mkOption {
                    type = lib.types.int;
                    default = 2000;
                    description = "The amount of energy it takes to extract one ingredient from an
...
disassemblerBreakChance setting).";
                  ...
                  droneAssemblyComplexity = lib.mkOption {
                    type = lib.types.int;
                    default = 15000;
                    description = "The additional amount of energy required to assemble a
drone for each point of complexity.";
                  };
                  eepromWrite = lib.mkOption {
                    type = lib.types.int;
                    default = 50;
                    description = "Energy it costs to re-program an EEPROM. This is deliberately
expensive, to discourage frequent re-writing of EEPROMs.";
                  ...
                  gpuClear = lib.mkOption {
                    type = lib.types.float;
                    default = 0.1;
                    description = "Energy it takes to clear a basic screen using the fill command with
...
screens.";
                  ...
                  gpuCopy = lib.mkOption {
                    type = lib.types.float;
                    default = 0.25;
                    description = "Energy it takes to copy half of a basic screen via the copy command.
Note: internally this is adjusted to a cost per pixel, and applied
as such, so this also implicitly defines the cost for higher tier
screens.";
                  };
                  gpuFill = lib.mkOption {
                    type = lib.types.int;
                    default = 1;
                    description = "Energy it takes to change a basic screen with the fill command.
Note: internally this is adjusted to a cost per pixel, and applied
as such, so this also implicitly defines the cost for higher tier
screens.";
                  };
                  gpuSet = lib.mkOption {
                    type = lib.types.int;
                    default = 2;
                    description = "Energy it takes to change *every* 'pixel' via the set command of a
...
screens.";
                  ...
                  hddRead = lib.mkOption {
                    type = lib.types.float;
                    default = 0.1;
                    description = "Energy it takes read one kilobyte from a file system. Note that non
...
as such. It's just specified per kilobyte to be more intuitive.";
                  ...
                  hddWrite = lib.mkOption {
                    type = lib.types.float;
                    default = 0.25;
                    description = "Energy it takes to write one kilobyte to a file system.
Note: internally this is adjusted to a cost per byte, and applied
as such. It's just specified per kilobyte to be more intuitive.";
                  };
                  hologram = lib.mkOption {
                    type = lib.types.float;
                    default = 0.2;
                    description = "The amount of energy a hologram projetor consumes per tick. This
...
displayed the hologram projector will not drain energy.";
                  ...
                  hoverBootAbsorb = lib.mkOption {
                    type = lib.types.int;
                    default = 10;
                    description = "The amount of energy consumed when the hover boots absorb some fall
velocity (i.e. when falling from something higher than three blocks).";
                  };
                  hoverBootJump = lib.mkOption {
                    type = lib.types.int;
                    default = 10;
                    description = "The amount of energy consumed when jumping with the hover boots. Only
applies when the jump boost is applied, i.e. when not sneaking.";
                  };
                  hoverBootMove = lib.mkOption {
                    type = lib.types.int;
                    default = 1;
                    description = "The amount of energy consumed *per second* when moving around while
...
moving very slowly this also does not trigger.";
                  ...
                  mfuRelay = lib.mkOption {
                    type = lib.types.int;
                    default = 1;
                    description = "Energy consumed by a MFU per tick while connected.
...
microcontroller for each point of complexity.";
                  ...
                  robot = lib.mkOption {
                    type = lib.types.float;
                    default = 0.25;
                    description = "The amount of energy a robot consumes per tick when running. This is
...
computers.";
                  ...
                  robotAssemblyComplexity = lib.mkOption {
                    type = lib.types.int;
                    default = 10000;
                    description = "The additional amount of energy required to assemble a robot for
each point of complexity.";
                  };
                  robotExhaustion = lib.mkOption {
                    type = lib.types.int;
                    default = 10;
                    description = "The conversion rate of exhaustion from using items to energy
...
exhaustion, attacking an entity generates 0.3 exhaustion.";
                  ...
                  screen = lib.mkOption {
                    type = lib.types.float;
                    default = 0.05;
                    description = "The amount of energy a screen consumes per tick. For each lit pixel
...
part of it will consume this amount of energy per tick.";
                  ...
                  sleepFactor = lib.mkOption {
                    type = lib.types.float;
                    default = 0.1;
                    description = "The actual cost per tick for computers and robots is multiplied
...
you can't fake sleep by calling `os.sleep(0)`.";
                  ...
                  tabletAssemblyComplexity = lib.mkOption {
                    type = lib.types.int;
                    default = 5000;
                    description = "The additional amount of energy required to assemble a tablet for
each point of complexity.";
                  };
                  transposer = lib.mkOption {
                    type = lib.types.int;
                    default = 1;
                    description = "Energy required for one transposer operation (regardless of the number
of items / fluid volume moved).";
                  };
                  wirelessCostPerRange = lib.mkOption {
                    type = lib.types.listOf lib.types.float;
                    default = [ 0.05 0.05 ];
                    description = "The amount of energy it costs to send a wireless message with signal
...
These values are for the tier 1 and 2 wireless cards, in that order.";
              ...
              disassemblerTickAmount = lib.mkOption {
                type = lib.types.int;
                default = 25;
                description = "The amount of energy the disassembler can apply per tick. This
controls the speed at which items are disassembled, basically.";
              };
              generatorEfficiency = lib.mkOption {
                type = lib.types.float;
                default = 0.8;
                description = "The energy efficiency of the generator upgrade. At 1.0 this will
...
default.";
              ...
              ignorePower = lib.mkOption {
                type = lib.types.bool;
                default = false;
                description = "Whether to ignore any power requirements. Whenever something requires
...
not accept power from other mods.";
              ...
              modBlacklist = lib.mkOption {
                type = lib.types.listOf lib.types.str;
                default = [ ];
                description = "If you don't want OpenComputers to accept power from one or more of the
...
`BuildCraftAPI|power`, `IC2`, `factorization`, ...";
              ...
              printerTickAmount = lib.mkOption {
                type = lib.types.int;
                default = 1;
                description = "The amount of energy the printer can apply per tick. This controls
the speed at which prints are completed, basically.";
              };
              rate = lib.mkOption {
                default = {};
                description = "The rate at which different blocks accept external power. All of these
values are in OC energy / tick.";
              ...
              ritegEfficiency = lib.mkOption {
                type = lib.types.float;
                default = 0.6;
                description = "The energy efficiency of the riteg upgrade. At 1.0 this will
...
Stirling Engine.";
              ...
              solarGeneratorEfficiency = lib.mkOption {
                type = lib.types.float;
                default = 0.2;
                description = "The energy efficiency of the solar generator upgrade. At 1.0 this will
generate as much energy as you'd get by burning  fuel in a BuildCraft
...
of solar generators is greatly reduced by default.";
              ...
              tickFrequency = lib.mkOption {
                type = lib.types.int;
                default = 10;
                description = "This determines how often continuous power sinks try to actually try to
...
`tickFrequency * cost`.";
              ...
              value = lib.mkOption {
                default = {};
                description = "Power values for different power systems. For reference, the value of
          ...
          printer = lib.mkOption {
            ...
            type = lib.types.submodule {
              ...
              chameliumEdible = lib.mkOption {
                type = lib.types.bool;
                default = true;
                description = "Whether Chamelium is edible or not. When eaten, it gives a (short)
invisibility buff, and (slightly longer) blindness debuff.";
              };
              customRedstoneCost = lib.mkOption {
                type = lib.types.int;
                default = 300;
                description = "The extra material cost involved for printing a model with a customized
redstone output, i.e. something in [1, 14].";
              };
              inkValue = lib.mkOption {
                type = lib.types.int;
                default = 50000;
                description = "The amount by which a printers ink buffer gets filled for a single
...
Note: the amount a single dye adds is this divided by 10.";
              ...
              materialValue = lib.mkOption {
                type = lib.types.int;
                default = 2000;
                description = "The amount by which a printers material buffer gets filled for a single
chamelium. Tweak this if you think printing is too cheap or expensive.";
              };
              maxBaseLightLevel = lib.mkOption {
                type = lib.types.int;
                default = 8;
                description = "The maximum light level a printed block can emit. This defaults to
...
achieved directly when printing them.";
              ...
              maxShapes = lib.mkOption {
                type = lib.types.int;
                default = 256;
                description = "The maximum number of shape for a state of a 3D print allowed. This is
...
will ever be visible at a time).";
              ...
              noclipMultiplier = lib.mkOption {
                type = lib.types.int;
                default = 2;
                description = "By what (linear) factor the cost of a print increases if one or both of
...
This only influences the chamelium cost.";
              ...
              printsHaveOpacity = lib.mkOption {
                type = lib.types.bool;
                default = false;
                description = "Whether to enable print opacity, i.e. make prints have shadows. If
...
enable this.";
              ...
              recycleRate = lib.mkOption {
                type = lib.types.float;
                default = 0.75;
                description = "How much of the material used to print a model is refunded when using
          ...
          robot = lib.mkOption {
            ...
            type = lib.types.submodule {
              ...
              allowActivateBlocks = lib.mkOption {
                type = lib.types.bool;
                default = true;
                description = "Whether robots may 'activate' blocks in the world. This includes
...
feature is too over-powered.";
              ...
              allowUseItemsWithDuration = lib.mkOption {
                type = lib.types.bool;
                default = true;
                description = "Whether robots may use items for a specifiable duration. This allows
...
robots cannot rapidly fire critical shots with a bow, for example.";
              ...
              canAttackPlayers = lib.mkOption {
                type = lib.types.bool;
                default = false;
                description = "Whether robots may damage players if they get in their way. This
              ...
              delays = lib.mkOption {
                ...
                type = lib.types.submodule {
                  ...
                  drop = lib.mkOption {
                    type = lib.types.float;
                    default = 0.5;
                    description = "The time in seconds to pause execution after an item was
successfully dropped from a robot's inventory.";
                  };
                  harvestRatio = lib.mkOption {
                    type = lib.types.int;
                    default = 1;
                    description = "This is the *ratio* of the time a player would require to harvest a
...
Breaking a block will always at least take one tick, 0.05 seconds.";
                  ...
                  move = lib.mkOption {
                    type = lib.types.float;
                    default = 0.4;
                    description = "The time in seconds to pause execution after a robot issued a
...
`harvestRatio` (see below) applies.";
                  ...
                  turn = lib.mkOption {
                    type = lib.types.float;
                    default = 0.4;
                    description = "The time in seconds to pause execution after a robot turned either
...
item use is taken.";
              ...
              itemDamageRate = lib.mkOption {
                type = lib.types.float;
                default = 0.1;
                description = "The rate at which items used as tools by robots take damage. A value of
...
immediately after it was used.";
              ...
              limitFlightHeight = lib.mkOption {
                type = lib.types.int;
                default = 8;
                description = "Limit robot flight height, based on the following rules:
...
unlimited flight capabilities instead!";
              ...
              nameFormat = lib.mkOption {
                ...
                description = "The name format to use for robots. The substring '$player$' is
...
block from another mod, the name will default to 'OpenComputers'.";
              ...
              notAfraidOfSpiders = lib.mkOption {
                type = lib.types.bool;
                default = true;
                description = "Determines whether robots are a pretty cool guy. Ususally cobwebs are
...
rationally explained by Steve's fear of spiders, anyway.";
              ...
              swingRange = lib.mkOption {
                type = lib.types.float;
                default = 0.49;
                description = "The 'range' of robots when swinging an equipped tool (left click). This
...
hit anything that's actually outside said block.";
              ...
              upgradeFlightHeight = lib.mkOption {
                type = lib.types.listOf lib.types.int;
                default = [ 64 256 ];
                description = "The maximum flight height with upgrades, tier one and tier two of the
hover upgrade, respectively.";
              };
              useAndPlaceRange = lib.mkOption {
                type = lib.types.float;
                default = 0.65;
                description = "The 'range' of robots when using an equipped tool (right click) or when
...
i.e. tilled dirt, so that they can plant seeds.";
              ...
              uuidFormat = lib.mkOption {
                type = lib.types.str;
                default = "$player$";
                description = "Controls the UUID robots are given. You can either specify a fixed UUID
...
$random$.";
              ...
              xp = lib.mkOption {
                default = {};
                description = "This controls how fast robots gain experience, and how that experience
alters the stats.";
                type = lib.types.submodule {
                  options = {
                  actionXp = lib.mkOption {
                    type = lib.types.float;
                    default = 0.05;
                    description = "This controls how much experience a robot gains for each successful
...
will *not* gain a robot any experience.";
                  ...
                  baseValue = lib.mkOption {
                    type = lib.types.int;
                    default = 50;
                    description = "The required amount per level is computed like this:
xp(level) = baseValue + (level * constantGrowth) ^ exponentialGrowth";
                  };
                  bufferPerLevel = lib.mkOption {
                    type = lib.types.int;
                    default = 5000;
                    description = "This is the amount of additional energy that fits into a robots
...
xp(level) = baseValue + (level * constantGrowth) ^ exponentialGrowth";
                  ...
                  exhaustionXpRate = lib.mkOption {
                    type = lib.types.int;
                    default = 1;
                    description = "This determines how much \"exhaustion\" contributes to a robots
...
xp(level) = baseValue + (level * constantGrowth) ^ exponentialGrowth";
                  ...
                  harvestSpeedBoostPerLevel = lib.mkOption {
                    type = lib.types.float;
                    default = 0.02;
                    description = "The increase in block harvest speed a robot gains per level. The time
...
0.12 seconds.";
                  ...
                  oreXpRate = lib.mkOption {
                    type = lib.types.int;
                    default = 4;
                    description = "This determines how much experience a robot gets for each real XP orb
...
two real experience points, redstone is worth 5.";
                  ...
                  toolEfficiencyPerLevel = lib.mkOption {
                    type = lib.types.float;
                    default = 0.01;
                    description = "The additional \"efficiency\" a robot gains in using tools with each
          ...
          switch = lib.mkOption {
            ...
            type = lib.types.submodule {
              ...
              defaultMaxQueueSize = lib.mkOption {
                type = lib.types.int;
                default = 20;
                description = "This is the size of the queue of a not upgraded switch. Increasing it
...
burst.";
              ...
              defaultRelayAmount = lib.mkOption {
                type = lib.types.int;
                default = 1;
                description = "The base number of packets that get relayed in one 'cycle'. The
cooldown between cycles is determined by the delay.";
              };
              defaultRelayDelay = lib.mkOption {
                type = lib.types.int;
                default = 5;
                description = "The delay a switch has by default between relaying packets (in ticks).
...
and may in extreme cases cause server lag.";
              ...
              queueSizeUpgrade = lib.mkOption {
                type = lib.types.int;
                default = 10;
                description = "This is the amount by which the queue size increases per tier of the
hard drive installed in the switch.";
              };
              relayAmountUpgrade = lib.mkOption {
                type = lib.types.int;
                default = 1;
                description = "The number of additional packets that get relayed per cycle, based on
...
two per item tier.";
              ...
              relayDelayUpgrade = lib.mkOption {
                type = lib.types.float;
                default = 1.5;
                description = "The amount of ticks the delay is *reduced* by per tier of the CPU
inserted into a switch.";
          ...
          version = lib.mkOption {
            ...
            description = "The version of OC this config was generated by. This is used to allow the
