          ...
          "offhand torch tweaks" = lib.mkOption {
            ...
            type = lib.types.submodule {
              ...
              "No Offhand Torch At All" = lib.mkOption {
                type = lib.types.bool;
                default = false;
                description = "Don't place torches from the offhand at all
Note: This overrides all other options [default: false]";
              ...
              "Offhand Torch With Tool Only" = lib.mkOption {
                type = lib.types.bool;
                default = false;
                description = "Don't place torches from the offhand unless the main hand contains a tool
...
Modded tools include Tinker's Construct tools (not weapons) [default: false]";
              ...
              torch_items = lib.mkOption {
                ...
                description = "These items will be count as torches
      ...
      general = lib.mkOption {
        ...
        type = lib.types.submodule {
          ...
          offhandBlacklist = lib.mkOption {
            type = lib.types.listOf lib.types.str;
            default = [ ];
            description = "These items will be unable to be swapped into the offhand.
Formatting of an item should be: modid:itemname
These should all be placed on separate lines between the provided '<' and '>'.
[default: ]";
          };
