          ...
          dysonswarm = lib.mkOption {
            ...
            type = lib.types.submodule {
              ...
              coolantFluid = lib.mkOption {
                type = lib.types.str;
                default = "cryotheum";
                description = "Name of the coolant to use
Will fallback to IC2 Coolant if this name is invalid [default: cryotheum]";
              };
              destroyModuleA = lib.mkOption {
                type = lib.types.float;
                default = 0.00005;
                description = "Each hour, n of m modules are destroyed according to this formula:
...
This sets the parameter base_chance. [range: 0.0 ~ 1.0, default: 0.066]";
              ...
              powerFactors = lib.mkOption {
                ...
                description = "Define a power factor for each dimension ID.
