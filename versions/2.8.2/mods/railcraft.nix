      ...
      general = lib.mkOption {
        ...
        type = lib.types.submodule {
          ...
          cannotMobsSpawnOnDecorBlocks = lib.mkOption {
            ...
            default = true;
            description = "
Cannot mobs Spawn on decor blocks
";
          };
          cannotMobsSpawnOnMechanism = lib.mkOption {
            ...
            default = true;
            description = "
Cannot mobs Spawn on Mechanism
";
          };
              ...
              firestone = lib.mkOption {
                ...
                type = lib.types.submodule {
                  ...
                  firestoneIgnitesBlocks = lib.mkOption {
                    ...
                    default = true;
                    description = "
Change to 'firestoneIgnitesBlocks=false' to disabled Firestone items igniting blocks around players
";
                  };
                  };
                };
