        ...
        general = lib.mkOption {
          ...
          type = lib.types.submodule {
            options = {
              ...
              "Disable Gear Render" = lib.mkOption {
                type = lib.types.bool;
                default = false;
                description = "Toggle this to disable rendering the GC gear on your body.";
              };
              "Allow Stations at Unreachables" = lib.mkOption {
                type = lib.types.bool;
                default = true;
                description = "Allow the creation of Space Station at unreachable Celestial Bodies";
              };
              ...
              "Enable Hand fill" = lib.mkOption {
                type = lib.types.bool;
                default = false;
                description = "You will be able to refill oxygen tank by crafting it with LOX cells if this is set to true.";
              };
