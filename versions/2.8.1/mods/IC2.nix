      ...
      balance = lib.mkOption {
        ...
        type = lib.types.submodule {
          ...
          energyRetainedInStorageBlockDrops = lib.mkOption {
            ...
            default = 0.8;
            description = "0 (nothing) ... 1 (100%), default 0.8 (80 %)";
          };
          ...
          minerDischargeTier = lib.mkOption {
            type = lib.types.int;
            default = 1;
            description = "1 = batteries, 2 = lead batteries, 3 = energy crystals, 4 = lapotron crystals";
          };
          recyclerBlacklist = lib.mkOption {
            ...
            description = "Ore dictionary entries can be specified with OreDict:<ore dict name> as the name.";
          };
          recyclerWhitelist = lib.mkOption {
            type = lib.types.str;
            default = "";
            description = "The format is the same as the blacklist.";
          };
      ...
      misc = lib.mkOption {
        ...
        type = lib.types.submodule {
          ...
          radiationPotionID = lib.mkOption {
            type = lib.types.int;
            default = 24;
            description = "Do not change this after you created a world...";
          };
          useLinearTransferModel = lib.mkOption {
            type = lib.types.bool;
            default = false;
            description = "Only set this to true if you know what you are doing.";
          };
          };
        };
      };
      ...
      recipes = lib.mkOption {
        ...
        type = lib.types.submodule {
          ...
          disable = lib.mkOption {
            type = lib.types.str;
            default = "";
            description = "Format: <name>[@metadata], e.g. minecraft:bucket to disable IC2's bucket recipe from tin.";
          };
          ...
          purge = lib.mkOption {
            type = lib.types.str;
            default = "";
            description = "Format: <name>[@metadata], e.g. minecraft:tnt to disable crafting tnt.";
          };
