          ...
          internet = lib.mkOption {
            ...
            type = lib.types.submodule {
              ...
              blacklist = lib.mkOption {
                ...
                description = "This is a list of blacklisted domain names. If an HTTP request is made
...
they are to delay each other.";
              ...
              whitelist = lib.mkOption {
                type = lib.types.listOf lib.types.str;
                default = [ ];
                description = "This is a list of whitelisted domain names. Requests may only be made
